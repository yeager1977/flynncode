...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "يلزم تسجيل العميل",
  "mcp.status.pending": "جارٍ الاتصال…",
  ...
  "settings.plugins.section.browse": "استعراض",
  "settings.plugins.section.installed": "المثبَّتة",
  "settings.plugins.source.all": "جميع المصادر",
  "settings.plugins.source.ecosystem": "المنظومة",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "إضافة خادم",
  "settings.mcp.type.local": "محلي",
  "settings.mcp.type.remote": "بعيد",
  "settings.mcp.empty": "لا توجد خوادم MCP مهيأة.",
  "settings.mcp.deleted": "تم حذف {{name}}.",
  "settings.mcp.errors.refresh": "تعذّر تحميل خوادم MCP.",
  "settings.mcp.status.pending": "جارٍ الاتصال…",
  "settings.mcp.action.connect": "اتصال",
  "settings.mcp.action.disconnect": "قطع الاتصال",
  "settings.mcp.action.authenticate": "مصادقة",
  "settings.mcp.action.edit": "تعديل",
  "settings.mcp.action.delete": "حذف",
  "settings.mcp.delete.title": "حذف خادم MCP",
  "settings.mcp.delete.body": "إزالة {{name}}؟ لا يمكن التراجع.",
  "settings.mcp.form.title.add": "إضافة خادم MCP",
  "settings.mcp.form.title.edit": "تعديل خادم MCP",
  "settings.mcp.form.subtitle": "اضبط إعدادات الاتصال.",
  "settings.mcp.form.name": "الاسم",
  "settings.mcp.form.command": "الأمر",
  "settings.mcp.form.command.hint": "مثال: npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "دليل العمل",
  "settings.mcp.form.url": "العنوان",
  "settings.mcp.form.env": "متغيرات البيئة",
  "settings.mcp.form.headers": "الترويسات",
  "settings.mcp.form.addRow": "إضافة صف",
  "settings.mcp.form.removeRow": "إزالة",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "معرّف العميل",
  "settings.mcp.form.oauth.clientSecret": "سر العميل",
  "settings.mcp.form.oauth.clientSecret.keep": "اتركه فارغًا للتجاوز — قد تكون إعادة المصادقة مطلوبة",
  "settings.mcp.form.oauth.scope": "النطاق",
  "settings.mcp.form.oauth.callbackPort": "منفذ الاستدعاء",
  "settings.mcp.form.oauth.disableAutodetect": "تعطيل الكشف التلقائي عن OAuth",
  "settings.mcp.form.enabled": "مُمكَّن",
  "settings.mcp.form.timeout": "المهلة (ms)",
  "settings.mcp.form.save": "حفظ",
  "settings.mcp.form.cancel": "إلغاء",
  "settings.mcp.form.error.name": "أدخل اسمًا.",
  "settings.mcp.form.error.command": "أدخل أمرًا.",
  "settings.mcp.form.error.url": "أدخل عنوان URL.",
  "settings.mcp.form.error.callbackPort": "يجب أن يكون منفذ الاستدعاء بين 1 و 65535.",
  "settings.mcp.form.error.timeout": "يجب أن تكون المهلة عددًا صحيحًا موجبًا.",
  "settings.mcp.errors.invalid": "صحّح الحقول المميزة.",
  "settings.mcp.errors.duplicate": "يوجد خادم بهذا الاسم بالفعل.",
  "settings.mcp.errors.noConfig": "لا يمكن قراءة تهيئة {{name}} — قد تكون معرّفة خارج المشروع.",
  "settings.mcp.edit.warn": "الحفظ يعيد الاتصال بهذا الخادم.",
  "settings.plugins.search.placeholder": "البحث في الإضافات…",
  "settings.plugins.detail.install": "تثبيت…",
  "settings.plugins.detail.copy": "نسخ مقتطف الإعدادات",
  "settings.plugins.detail.copied": "تم النسخ",
  "settings.plugins.detail.notOnNpm": "غير موجود على npm — أضِفه يدويًا إلى opencode.json",
  "settings.plugins.install.title": "تثبيت إضافة",
  "settings.plugins.install.description": "أين يُضاف {{name}}؟",
  "settings.plugins.install.global": "عالمي (~/.config/opencode)",
  "settings.plugins.install.project": "هذا المشروع",
  "settings.plugins.install.cancel": "إلغاء",
  "settings.plugins.install.success": "تم تثبيت {{name}}. أعد تشغيل OpenCode لتحميله.",
  "settings.plugins.installed.empty": "لا توجد إضافات مثبَّتة.",
  "settings.plugins.installed.provenance.global": "عالمي",
  "settings.plugins.installed.provenance.project": "مشروع",
  ...
  "settings.plugins.errors.catalog": "تعذّر تحديث كتالوج الإضافات.",
  "settings.plugins.stale": "يُعرض الكتالوج المخزَّن مؤقتًا (منذ {{age}}).",
