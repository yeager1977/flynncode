...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "müştəri qeydiyyatı tələb olunur",
  "mcp.status.pending": "qoşulur…",
  ...
  "settings.tab.plugins": "Plaqinlər",
  "settings.plugins.section.browse": "Gəzin",
  "settings.plugins.section.installed": "Quraşdırılmış",
  ...
  "settings.mcp.add": "Server əlavə et",
  "settings.mcp.type.local": "Yerli",
  "settings.mcp.type.remote": "Uzaq",
  "settings.mcp.empty": "Konfiqurasiya edilmiş MCP serveri yoxdur.",
  "settings.mcp.deleted": "{{name}} silindi.",
  "settings.mcp.errors.refresh": "MCP serverləri yüklənə bilmədi.",
  "settings.mcp.status.pending": "qoşulur…",
  "settings.mcp.action.connect": "Qoş",
  "settings.mcp.action.disconnect": "Ayır",
  "settings.mcp.action.authenticate": "Doğrula",
  "settings.mcp.action.edit": "Redaktə",
  "settings.mcp.action.delete": "Sil",
  "settings.mcp.delete.title": "MCP serverini sil",
  "settings.mcp.delete.body": "{{name}} silinsin? Bu geri qaytarıla bilməz.",
  "settings.mcp.form.title.add": "MCP server əlavə et",
  "settings.mcp.form.title.edit": "MCP serveri redaktə et",
  "settings.mcp.form.subtitle": "Bağlantı parametrlərini tənzimlə.",
  "settings.mcp.form.name": "Ad",
  "settings.mcp.form.command": "Əmr",
  "settings.mcp.form.command.hint": "məs. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "İş qovluğu",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Mühit dəyişənləri",
  "settings.mcp.form.headers": "Başlıqlar",
  "settings.mcp.form.addRow": "Sətir əlavə et",
  "settings.mcp.form.removeRow": "Sil",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Müştəri ID",
  "settings.mcp.form.oauth.clientSecret": "Müştəri sirri",
  "settings.mcp.form.oauth.clientSecret.keep": "Ötürmək üçün boş buraxın — yenidən autentifikasiya tələb oluna bilər",
  "settings.mcp.form.oauth.scope": "Sahə",
  "settings.mcp.form.oauth.callbackPort": "Geriyə zəng portu",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth avtomatik aşkarlamasını söndür",
  "settings.mcp.form.enabled": "Aktiv",
  "settings.mcp.form.timeout": "Vaxt məhdudiyyəti (ms)",
  "settings.mcp.form.save": "Yadda saxla",
  "settings.mcp.form.cancel": "Ləğv et",
  "settings.mcp.form.error.name": "Ad daxil edin.",
  "settings.mcp.form.error.command": "Əmr daxil edin.",
  "settings.mcp.form.error.url": "URL daxil edin.",
  "settings.mcp.form.error.callbackPort": "Geriyə zəng portu 1-65535 arasında olmalıdır.",
  "settings.mcp.form.error.timeout": "Vaxt məhdudiyyəti müsbət tam ədəd olmalıdır.",
  "settings.mcp.errors.invalid": "Vurğulanmış sahələri düzəldin.",
  "settings.mcp.errors.duplicate": "Bu adda server artıq mövcuddur.",
  "settings.mcp.errors.noConfig": "{{name}} üçün konfiqurasiya oxunmur — layihədən kənarda müəyyən edilmiş ola bilər.",
  "settings.mcp.edit.warn": "Yadda saxlamaq bu serveri yenidən birləşdirir.",
  ...
  "settings.plugins.detail.notOnNpm": "npm-də tapılmadı — opencode.json-a əl ilə əlavə edin",
  "settings.plugins.install.title": "Plaqin quraşdır",
  "settings.plugins.install.description": "{{name}} haraya əlavə edilsin?",
  "settings.plugins.install.global": "Qlobal (~/.config/opencode)",
  "settings.plugins.install.project": "Bu layihə",
  "settings.plugins.install.cancel": "Ləğv et",
  "settings.plugins.install.success": "{{name}} quraşdırıldı. Yükləmək üçün OpenCode-u yenidən başladın.",
  "settings.plugins.installed.empty": "Quraşdırılmış plaqin yoxdur.",
  "settings.plugins.installed.provenance.global": "Qlobal",
  "settings.plugins.installed.provenance.project": "Layihə",
  ...
  "settings.plugins.errors.catalog": "Plaqin kataloqu yenilənə bilmədi.",
  "settings.plugins.stale": "Keşlənmiş kataloq göstərilir ({{age}} əvvəlki).",
