...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "изисква регистрация на клиент",
  "mcp.status.pending": "свързване…",
  ...
  "settings.tab.plugins": "Приставки",
  "settings.plugins.section.browse": "Разглеждане",
  "settings.plugins.section.installed": "Инсталирани",
  "settings.plugins.source.all": "Всички източници",
  "settings.plugins.source.ecosystem": "Екосистема",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Добавяне на сървър",
  "settings.mcp.type.local": "Локален",
  "settings.mcp.type.remote": "Отдалечен",
  "settings.mcp.empty": "Няма конфигурирани MCP сървъри.",
  "settings.mcp.deleted": "{{name}} е изтрит.",
  "settings.mcp.errors.refresh": "Сървърите MCP не можаха да се заредят.",
  "settings.mcp.status.pending": "свързване…",
  "settings.mcp.action.connect": "Свързване",
  "settings.mcp.action.disconnect": "Разказване",
  "settings.mcp.action.authenticate": "Удостоверяване",
  "settings.mcp.action.edit": "Редактиране",
  "settings.mcp.action.delete": "Изтриване",
  "settings.mcp.delete.title": "Изтриване на MCP сървър",
  "settings.mcp.delete.body": "Да се премахне ли {{name}}? Действието е необратимо.",
  "settings.mcp.form.title.add": "Добавяне на MCP сървър",
  "settings.mcp.form.title.edit": "Редактиране на MCP сървър",
  "settings.mcp.form.subtitle": "Настройте параметрите на връзката.",
  "settings.mcp.form.name": "Име",
  "settings.mcp.form.command": "Команда",
  "settings.mcp.form.command.hint": "напр. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Работна директория",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Променливи на средата",
  "settings.mcp.form.headers": "Заглавки",
  "settings.mcp.form.addRow": "Добави ред",
  "settings.mcp.form.removeRow": "Премахни",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID на клиент",
  "settings.mcp.form.oauth.clientSecret": "Тайна на клиента",
  "settings.mcp.form.oauth.clientSecret.keep": "Оставете празно, за да пропуснете — може да е необходима повторна автентикация",
  "settings.mcp.form.oauth.scope": "Обхват",
  "settings.mcp.form.oauth.callbackPort": "Порт за обратно извикване",
  "settings.mcp.form.oauth.disableAutodetect": "Изключи автоматичното откриване на OAuth",
  "settings.mcp.form.enabled": "Активиран",
  "settings.mcp.form.timeout": "Изчакване (ms)",
  "settings.mcp.form.save": "Запази",
  "settings.mcp.form.cancel": "Отказ",
  "settings.mcp.form.error.name": "Въведете име.",
  "settings.mcp.form.error.command": "Въведете команда.",
  "settings.mcp.form.error.url": "Въведете URL.",
  "settings.mcp.form.error.callbackPort": "Портът за обратно извикване трябва да е между 1 и 65535.",
  "settings.mcp.form.error.timeout": "Изчакването трябва да е положително цяло число.",
  "settings.mcp.errors.invalid": "Коригирайте маркираните полета.",
  "settings.mcp.errors.duplicate": "Вече съществува сървър с това име.",
  "settings.mcp.errors.noConfig": "Конфигурацията на {{name}} не може да се прочете — може да е дефинирана извън проекта.",
  "settings.mcp.edit.warn": "Запазването свързва отново сървъра.",
  "settings.plugins.search.placeholder": "Търсене на приставки…",
  "settings.plugins.detail.install": "Инсталиране…",
  "settings.plugins.detail.copy": "Копиране на откъс от конфигурацията",
  "settings.plugins.detail.copied": "Копирано",
  "settings.plugins.detail.notOnNpm": "Не е намерена в npm — добавете ръчно в opencode.json",
  "settings.plugins.install.title": "Инсталиране на приставка",
  "settings.plugins.install.description": "Къде да се добави {{name}}?",
  "settings.plugins.install.global": "Глобално (~/.config/opencode)",
  "settings.plugins.install.project": "Този проект",
  "settings.plugins.install.cancel": "Отказ",
  "settings.plugins.install.success": "{{name}} е инсталирана. Рестартирайте OpenCode, за да се зареди.",
  "settings.plugins.installed.empty": "Няма инсталирани приставки.",
  ...
  "settings.plugins.errors.catalog": "Каталогът на приставките не можа да се обнови.",
  "settings.plugins.stale": "Показва се кеширан каталог (на {{age}}).",
