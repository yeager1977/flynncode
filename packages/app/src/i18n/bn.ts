export const dict: Record<string, string> = {
  ...
  "mcp.status.needs_client_registration": "ক্লায়েন্ট নিবন্ধন প্রয়োজন",
  "mcp.status.pending": "সংযোগ হচ্ছে…",
  ...
  "settings.tab.plugins": "প্লাগইন",
  "settings.plugins.section.browse": "ব্রাউজ",
  "settings.plugins.section.installed": "ইনস্টল করা",
  "settings.plugins.source.all": "সব উৎস",
  "settings.plugins.source.ecosystem": "ইকোসিস্টেম",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "সার্ভার যোগ করুন",
  "settings.mcp.type.local": "স্থানীয়",
  "settings.mcp.type.remote": "রিমোট",
  "settings.mcp.empty": "কোনো MCP সার্ভার কনফিগার করা নেই।",
  "settings.mcp.deleted": "{{name}} মুছে ফেলা হয়েছে।",
  "settings.mcp.errors.refresh": "MCP সার্ভার লোড করা যায়নি।",
  "settings.mcp.status.pending": "সংযোগ হচ্ছে…",
  "settings.mcp.action.connect": "সংযোগ করুন",
  "settings.mcp.action.disconnect": "সংযোগ বিচ্ছিন্ন করুন",
  "settings.mcp.action.authenticate": "প্রমাণীকরণ করুন",
  "settings.mcp.action.edit": "সম্পাদনা করুন",
  "settings.mcp.action.delete": "মুছুন",
  "settings.mcp.delete.title": "MCP সার্ভার মুছুন",
  "settings.mcp.delete.body": "{{name}} সরাবেন? এটি বাতিল করা যাবে না।",
  "settings.mcp.form.title.add": "MCP সার্ভার যোগ করুন",
  "settings.mcp.form.title.edit": "MCP সার্ভার সম্পাদনা করুন",
  "settings.mcp.form.subtitle": "কানেকশন সেটিংস কনফিগার করুন।",
  "settings.mcp.form.name": "নাম",
  "settings.mcp.form.command": "কমান্ড",
  "settings.mcp.form.command.hint": "যেমন npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "ওয়ার্কিং ডিরেক্টরি",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "এনভায়রনমেন্ট ভেরিয়েবল",
  "settings.mcp.form.headers": "হেডার",
  "settings.mcp.form.addRow": "সারি যোগ করুন",
  "settings.mcp.form.removeRow": "সরান",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ক্লায়েন্ট ID",
  "settings.mcp.form.oauth.clientSecret": "ক্লায়েন্ট সিক্রেট",
  "settings.mcp.form.oauth.clientSecret.keep": "বাদ দিতে খালি রাখুন — পুনঃপ্রমাণীকরণ প্রয়োজন হতে পারে",
  "settings.mcp.form.oauth.scope": "স্কোপ",
  "settings.mcp.form.oauth.callbackPort": "কলব্যাক পোর্ট",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth অটো-ডিটেকশন নিষ্ক্রিয় করুন",
  "settings.mcp.form.enabled": "সক্ষম",
  "settings.mcp.form.timeout": "টাইমআউট (ms)",
  "settings.mcp.form.save": "সংরক্ষণ করুন",
  "settings.mcp.form.cancel": "বাতিল",
  "settings.mcp.form.error.name": "নাম লিখুন।",
  "settings.mcp.form.error.command": "কমান্ড লিখুন।",
  "settings.mcp.form.error.url": "URL লিখুন।",
  "settings.mcp.form.error.callbackPort": "কলব্যাক পোর্ট ১-৬৫৫৩৫ এর মধ্যে হতে হবে।",
  "settings.mcp.form.error.timeout": "টাইমআউট ধনাত্মক পূর্ণসংখ্যা হতে হবে।",
  "settings.mcp.errors.invalid": "হাইলাইট করা ফিল্ড ঠিক করুন।",
  "settings.mcp.errors.duplicate": "এই নামে একটি সার্ভার আগেই আছে।",
  "settings.mcp.errors.noConfig": "{{name}}-এর কনফিগ পড়া যায়নি — প্রজেক্টের বাইরে সংজ্ঞায়িত হতে পারে।",
  "settings.mcp.edit.warn": "সংরক্ষণ করলে এই সার্ভার পুনঃসংযুক্ত হবে।",
  "settings.plugins.search.placeholder": "প্লাগইন খুঁজুন…",
  "settings.plugins.detail.install": "ইনস্টল করুন…",
  "settings.plugins.detail.copy": "কনফিগ স্নিপেট কপি করুন",
  "settings.plugins.detail.copied": "কপি হয়েছে",
  "settings.plugins.detail.notOnNpm": "npm-এ পাওয়া যায়নি — opencode.json-এ ম্যানুয়ালি যোগ করুন",
  "settings.plugins.install.title": "প্লাগইন ইনস্টল করুন",
  "settings.plugins.install.description": "{{name}} কোথায় যোগ হবে?",
  "settings.plugins.install.global": "গ্লোবাল (~/.config/opencode)",
  "settings.plugins.install.project": "এই প্রজেক্ট",
  "settings.plugins.install.cancel": "বাতিল",
  "settings.plugins.install.success": "{{name}} ইনস্টল হয়েছে। লোড করতে OpenCode পুনরায় চালু করুন।",
  "settings.plugins.installed.empty": "কোনো প্লাগইন ইনস্টল করা নেই।",
  "settings.plugins.installed.provenance.global": "গ্লোবাল",
  "settings.plugins.installed.provenance.project": "প্রজেক্ট",
  ...
  "settings.plugins.errors.catalog": "প্লাগইন ক্যাটালগ রিফ্রেশ করা যায়নি।",
  "settings.plugins.stale": "ক্যাশ করা ক্যাটালগ দেখানো হচ্ছে ({{age}} পুরনো)।",
