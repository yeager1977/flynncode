export const dict = {
  ...
  "mcp.status.needs_client_registration": "enrolladur pratik rekiset",
  "mcp.status.pending": "o kevreañ…",
  ...
  "settings.tab.plugins": "Pelestradurioù",
  "settings.plugins.section.browse": "Furchal",
  "settings.plugins.section.installed": "Staliet",
  ...
  "settings.mcp.add": "Ouzhpennañ un dafariad",
  "settings.mcp.type.local": "Lec'hel",
  "settings.mcp.type.remote": "A-bell",
  "settings.mcp.empty": "N'eus dafariad MCP kefluniet ebet.",
  "settings.mcp.deleted": "{{name}} dilammet.",
  "settings.mcp.errors.refresh": "N'haller ket kargañ an dafariadoù MCP.",
  "settings.mcp.status.pending": "o kevreañ…",
  "settings.mcp.action.connect": "Kevreañ",
  "settings.mcp.action.disconnect": "Digevreañ",
  "settings.mcp.action.authenticate": "Autentikañ",
  "settings.mcp.action.edit": "Aozañ",
  "settings.mcp.action.delete": "Diverkañ",
  "settings.mcp.delete.title": "Diverkañ an dafariad MCP",
  "settings.mcp.delete.body": "Dilemel {{name}}? An oberiadenn-mañ a zo diaes da zistorel.",
  "settings.mcp.form.title.add": "Ouzhpennañ un dafariad MCP",
  "settings.mcp.form.title.edit": "Kemmañ an dafariad MCP",
  "settings.mcp.form.subtitle": "Kefluniañ arventennoù ar c'hevreadur.",
  "settings.mcp.form.name": "Anv",
  "settings.mcp.form.command": "Urzhiad",
  "settings.mcp.form.command.hint": "da sk. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Teuliad labour",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Argemmoù endro",
  "settings.mcp.form.headers": "Talbennoù",
  "settings.mcp.form.addRow": "Ouzhpennañ ul linenn",
  "settings.mcp.form.removeRow": "Dilemel",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID ar pratik",
  "settings.mcp.form.oauth.clientSecret": "Sekred ar pratik",
  "settings.mcp.form.oauth.clientSecret.keep": "Leave blank to omit — re-authentication may be required",
  "settings.mcp.form.oauth.scope": "Sked",
  "settings.mcp.form.oauth.callbackPort": "Porzh adgelad",
  "settings.mcp.form.oauth.disableAutodetect": "Diweredekaat anaoudadur emgefre OAuth",
  "settings.mcp.form.enabled": "Gweredekaet",
  "settings.mcp.form.timeout": "Amzer hoc'h_eas (ms)",
  "settings.mcp.form.save": "Enrollañ",
  "settings.mcp.form.cancel": "Nullañ",
  "settings.mcp.form.error.name": "Enankit un anv.",
  "settings.mcp.form.error.command": "Enankit un urzhiad.",
  "settings.mcp.form.error.url": "Enankit un URL.",
  "settings.mcp.form.error.callbackPort": "Ar porzh adgelad a rank bezañ etre 1 ha 65535.",
  "settings.mcp.form.error.timeout": "An amzer-hed a rank bezañ un niver anterin pozitivel.",
  "settings.mcp.errors.invalid": "Reizhit ar maezioù usskedet.",
  "settings.mcp.errors.duplicate": "Bez' ez eus dija un dafariad gant an anv-mañ.",
  "settings.mcp.errors.noConfig": "Ne c'haller ket lenn kefluniad {{name}} — marteze dielfennet e-maez ar raktres.",
  "settings.mcp.edit.warn": "Enrollañ a adkevreañs an dafariad-mañ.",
  ...
  "settings.plugins.detail.copied": "Eilet",
  "settings.plugins.detail.notOnNpm": "N'eo ket bet kavet war npm — ouzhpennañ d'ar c'hefluniañ dre zorn",
  "settings.plugins.install.title": "Staliañ ar pelestredur",
  "settings.plugins.install.description": "Pelech e vo ouzhpennet {{name}}?",
  "settings.plugins.install.global": "Hollek (~/.config/opencode)",
  "settings.plugins.install.project": "Ar raktres-mañ",
  "settings.plugins.install.cancel": "Nullañ",
  "settings.plugins.install.success": "{{name}} staliet. Adloc'hit OpenCode evit kargañ anezhañ.",
  "settings.plugins.installed.empty": "Pelestradur stal ebet.",
  "settings.plugins.installed.provenance.global": "Hollek",
  "settings.plugins.installed.provenance.project": "Raktres",
  ...
  "settings.plugins.errors.catalog": "Dibosupl eo freskaat katalog ar pelestradurioù.",
  "settings.plugins.stale": "Emañ katalog ar c'heñverva o vezañ diskouezet ({{age}} zo).",
