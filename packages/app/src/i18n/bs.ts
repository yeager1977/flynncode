...
export const dict = {
  ...
  "settings.mcp.add": "Dodaj server",
  "settings.mcp.type.local": "Lokalni",
  "settings.mcp.type.remote": "Udaljeni",
  "settings.mcp.empty": "Nema konfigurisanih MCP servera.",
  "settings.mcp.deleted": "{{name}} je izbrisan.",
  "settings.mcp.errors.refresh": "Učitavanje MCP servera nije uspjelo.",
  ...
  "settings.mcp.delete.title": "Izbriši MCP server",
  "settings.mcp.delete.body": "Ukloniti {{name}}? Ovo se ne može poništiti.",
  "settings.mcp.form.title.add": "Dodaj MCP server",
  "settings.mcp.form.title.edit": "Uredi MCP server",
  "settings.mcp.form.subtitle": "Konfiguriši postavke veze.",
  ...
  "settings.mcp.form.addRow": "Dodaj red",
  ...
  "settings.mcp.form.oauth.disableAutodetect": "Onemogući automatsko otkrivanje OAuth-a",
  "settings.mcp.form.enabled": "Omogućeno",
  "settings.mcp.form.timeout": "Vremensko ograničenje (ms)",
  "settings.mcp.form.save": "Sačuvaj",
  "settings.mcp.form.cancel": "Otkaži",
  "settings.mcp.form.error.name": "Unesite naziv.",
  "settings.mcp.form.error.command": "Unesite komandu.",
  ...
  "settings.mcp.errors.invalid": "Ispravite označena polja.",
  "settings.mcp.errors.duplicate": "Server sa ovim nazivom već postoji.",
  "settings.mcp.errors.noConfig": "Konfiguraciju za {{name}} nije moguće pročitati — možda je definisana izvan projekta.",
  "settings.mcp.edit.warn": "Čuvanje ponovo povezuje ovaj server.",
  ...
  "settings.plugins.install.project": "Ovaj projekat",
  "settings.plugins.install.cancel": "Otkaži",
  ...
  "settings.plugins.installed.provenance.project": "Projekat",
  ...
  "settings.plugins.installed.uninstallBody": "Deinstalirati {{name}} iz {{scope}}? Biće uklonjen iz konfiguracijske datoteke.",
  "settings.plugins.installed.recentlyRemoved": "Nedavno uklonjeno",
  "settings.plugins.installed.openConfig": "Otvori konfiguraciju",
  "settings.plugins.errors.parseFailed": "Nije moguće čitati {{path}} — popravite ili uklonite datoteku za upravljanje dodacima.",
  "settings.plugins.errors.catalog": "Nije moguće osvježiti katalog dodataka.",
  "settings.plugins.stale": "Prikazuje se keširani katalog ({{age}} star).",
