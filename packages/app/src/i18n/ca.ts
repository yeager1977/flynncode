...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "cal registre de client",
  "mcp.status.pending": "connectant…",
  ...
  "settings.tab.plugins": "Complements",
  "settings.plugins.section.browse": "Explora",
  "settings.plugins.section.installed": "Instal·lats",
  ...
  "settings.mcp.add": "Afegeix servidor",
  "settings.mcp.type.local": "Local",
  "settings.mcp.type.remote": "Remot",
  "settings.mcp.empty": "No hi ha servidors MCP configurats.",
  "settings.mcp.deleted": "{{name}} suprimit.",
  "settings.mcp.errors.refresh": "No s'han pogut carregar els servidors MCP.",
  "settings.mcp.status.pending": "connectant…",
  "settings.mcp.action.connect": "Connecta",
  "settings.mcp.action.disconnect": "Desconnecta",
  "settings.mcp.action.authenticate": "Autentica",
  "settings.mcp.action.edit": "Edita",
  "settings.mcp.action.delete": "Suprimeix",
  "settings.mcp.delete.title": "Suprimeix el servidor MCP",
  "settings.mcp.delete.body": "Voleu suprimir {{name}}? No es pot desfer.",
  "settings.mcp.form.title.add": "Afegeix un servidor MCP",
  "settings.mcp.form.title.edit": "Edita el servidor MCP",
  "settings.mcp.form.subtitle": "Configura els paràmetres de connexió.",
  "settings.mcp.form.name": "Nom",
  "settings.mcp.form.command": "Ordre",
  "settings.mcp.form.command.hint": "p. ex. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Directori de treball",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Variables d'entorn",
  "settings.mcp.form.headers": "Capçaleres",
  "settings.mcp.form.addRow": "Afegeix una fila",
  "settings.mcp.form.removeRow": "Elimina",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID de client",
  "settings.mcp.form.oauth.clientSecret": "Secret de client",
  "settings.mcp.form.oauth.clientSecret.keep": "Deixa-ho en blanc per ometre — pot caldre re-autenticació",
  "settings.mcp.form.oauth.scope": "Àmbit",
  "settings.mcp.form.oauth.callbackPort": "Port de callback",
  "settings.mcp.form.oauth.disableAutodetect": "Desactiva la detecció automàtica d'OAuth",
  "settings.mcp.form.enabled": "Activat",
  "settings.mcp.form.timeout": "Temps d'espera (ms)",
  "settings.mcp.form.save": "Desa",
  "settings.mcp.form.cancel": "Cancel·la",
  "settings.mcp.form.error.name": "Introdueix un nom.",
  "settings.mcp.form.error.command": "Introdueix una ordre.",
  "settings.mcp.form.error.url": "Introdueix una URL.",
  "settings.mcp.form.error.callbackPort": "El port de callback ha d'estar entre 1 i 65535.",
  "settings.mcp.form.error.timeout": "El temps d'espera ha de ser un nombre enter positiu.",
  "settings.mcp.errors.invalid": "Corregeix els camps destacats.",
  "settings.mcp.errors.duplicate": "Ja existeix un servidor amb aquest nom.",
  "settings.mcp.errors.noConfig": "No es pot llegir la configuració de {{name}} — pot estar definida fora del projecte.",
  "settings.mcp.edit.warn": "Desar torna a connectar aquest servidor.",
  ...
  "settings.plugins.detail.notOnNpm": "No s'ha trobat a npm — afegeix-lo manualment a opencode.json",
  "settings.plugins.install.title": "Instal·la el complement",
  "settings.plugins.install.description": "On s'ha d'afegir {{name}}?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Aquest projecte",
  "settings.plugins.install.cancel": "Cancel·la",
  "settings.plugins.install.success": "{{name}} instal·lat. Reinicia OpenCode per carregar-lo.",
  "settings.plugins.installed.empty": "No hi ha complements instal·lats.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Projecte",
  ...
  "settings.plugins.errors.catalog": "No s'ha pogut actualitzar el catàleg de complements.",
  "settings.plugins.stale": "Es mostra el catàleg en memòria cau (de fa {{age}}).",
