...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "Client-Registrierung nötig",
  "mcp.status.pending": "verbinden…",
  ...
  "settings.plugins.section.browse": "Durchsuchen",
  "settings.plugins.section.installed": "Installiert",
  "settings.plugins.source.all": "Alle Quellen",
  ...
  "settings.mcp.deleted": "{{name}} gelöscht.",
  "settings.mcp.errors.refresh": "MCP-Server konnten nicht geladen werden.",
  "settings.mcp.status.pending": "verbinden…",
  "settings.mcp.action.connect": "Verbinden",
  "settings.mcp.action.disconnect": "Trennen",
  "settings.mcp.action.authenticate": "Authentifizieren",
  "settings.mcp.action.edit": "Bearbeiten",
  "settings.mcp.action.delete": "Löschen",
  "settings.mcp.delete.title": "MCP-Server löschen",
  "settings.mcp.delete.body": "{{name}} entfernen? Dies kann nicht rückgängig gemacht werden.",
  "settings.mcp.form.title.add": "MCP-Server hinzufügen",
  "settings.mcp.form.title.edit": "MCP-Server bearbeiten",
  "settings.mcp.form.subtitle": "Verbindungseinstellungen konfigurieren.",
  "settings.mcp.form.name": "Name",
  "settings.mcp.form.command": "Befehl",
  "settings.mcp.form.command.hint": "z. B. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Arbeitsverzeichnis",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Umgebungsvariablen",
  "settings.mcp.form.headers": "Header",
  "settings.mcp.form.addRow": "Zeile hinzufügen",
  "settings.mcp.form.removeRow": "Entfernen",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Client-ID",
  "settings.mcp.form.oauth.clientSecret": "Client-Geheimnis",
  "settings.mcp.form.oauth.clientSecret.keep": "Leer lassen zum Auslassen — erneute Authentifizierung kann erforderlich sein",
  "settings.mcp.form.oauth.scope": "Scope",
  "settings.mcp.form.oauth.callbackPort": "Callback-Port",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth-Autoerkennung deaktivieren",
  "settings.mcp.form.enabled": "Aktiviert",
  "settings.mcp.form.timeout": "Zeitlimit (ms)",
  "settings.mcp.form.save": "Speichern",
  "settings.mcp.form.cancel": "Abbrechen",
  "settings.mcp.form.error.name": "Gib einen Namen ein.",
  "settings.mcp.form.error.command": "Gib einen Befehl ein.",
  "settings.mcp.form.error.url": "Gib eine URL ein.",
  "settings.mcp.form.error.callbackPort": "Callback-Port muss eine Zahl zwischen 1 und 65535 sein.",
  "settings.mcp.form.error.timeout": "Zeitlimit muss eine positive ganze Zahl sein.",
  "settings.mcp.errors.invalid": "Korrigiere die markierten Felder.",
  "settings.mcp.errors.duplicate": "Ein Server mit diesem Namen existiert bereits.",
  "settings.mcp.errors.noConfig": "Konfiguration für {{name}} kann nicht gelesen werden — sie ist evtl. außerhalb der Projektkonfiguration definiert.",
  "settings.mcp.edit.warn": "Speichern verbindet diesen Server neu.",
  "settings.plugins.search.placeholder": "Plugins suchen…",
  "settings.plugins.detail.install": "Installieren…",
  "settings.plugins.detail.copy": "Konfigurationsausschnitt kopieren",
  "settings.plugins.detail.copied": "Kopiert",
  "settings.plugins.detail.notOnNpm": "Nicht auf npm gefunden — manuell in opencode.json eintragen",
  "settings.plugins.install.title": "Plugin installieren",
  "settings.plugins.install.description": "Wo soll {{name}} hinzugefügt werden?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Dieses Projekt",
  "settings.plugins.install.cancel": "Abbrechen",
  "settings.plugins.install.success": "{{name}} installiert. OpenCode neu starten, um es zu laden.",
  "settings.plugins.installed.empty": "Keine Plugins installiert.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Projekt",
  "settings.plugins.installed.disable": "Deaktivieren",
  "settings.plugins.installed.enable": "Aktivieren",
  "settings.plugins.installed.uninstall": "Deinstallieren",
  "settings.plugins.installed.uninstallBody": "{{name}} von {{scope}} deinstallieren? Er wird aus der Konfigurationsdatei entfernt.",
  "settings.plugins.installed.recentlyRemoved": "Kürzlich entfernt",
  "settings.plugins.installed.openConfig": "Konfiguration öffnen",
  "settings.plugins.errors.parseFailed": "{{path}} kann nicht gelesen werden — Datei korrigieren oder entfernen, um Plugins dort zu verwalten.",
  "settings.plugins.errors.catalog": "Plugin-Katalog konnte nicht aktualisiert werden.",
  "settings.plugins.stale": "Zeige zwischengespeicherten Katalog ({{age}} alt).",
