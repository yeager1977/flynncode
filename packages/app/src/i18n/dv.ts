...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "ކްލައިންޓް ރެޖިސްޓްރޭޝަން ޖެހޭ",
  "mcp.status.pending": "ގުޅާލައިފައި…",
  ...
  "settings.tab.plugins": "ޕްލަގިންތައް",
  "settings.plugins.section.browse": "ބްރައުޒް",
  "settings.plugins.section.installed": "އެންސެލްވެފައި",
  ...
  "settings.mcp.add": "ސަރވަރ އިތުރުކުރޭ",
  "settings.mcp.type.local": "ލޯކަލް",
  "settings.mcp.type.remote": "ރިމޯޓް",
  "settings.mcp.empty": "ކޮނފިގް ކުރެވިފައިވާ MCP ސަރވަރ ނުވޭނީ.",
  "settings.mcp.deleted": "{{name}} ފުރައިފައި",
  "settings.mcp.errors.refresh": "MCP ސަރވަރ ލޯޑް ކުރުން ފޭލް",
  "settings.mcp.status.pending": "ގުޅާލައިފައި…",
  "settings.mcp.action.connect": "ގުޅުއާ",
  "settings.mcp.action.disconnect": "ވަކިކުރޭ",
  "settings.mcp.action.authenticate": "އެންތެންޓިކޭޓް",
  "settings.mcp.action.edit": "އެޑިޓް",
  "settings.mcp.action.delete": "ފުރައި",
  "settings.mcp.delete.title": "MCP ސަރވަރ ފުރައި",
  "settings.mcp.delete.body": "{{name}} ފުރައިފައި؟ އެއީ އަނބުރާ ކުރެވޭނެ ކަން ނޫނެވެ.",
  "settings.mcp.form.title.add": "MCP ސަރވަރ އިތުރު",
  "settings.mcp.form.title.edit": "MCP ސަރވަރ އެޑިޓް",
  "settings.mcp.form.subtitle": "ކޮނެކްޝަން ސެޓިންގްސް ކޮންފިގް ކުރޭ.",
  "settings.mcp.form.name": "ނަން",
  "settings.mcp.form.command": "ކޮމާންޑް",
  "settings.mcp.form.command.hint": "މިސާލު npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "ވޯކިންގ ޑައިރެކްޓަރީ",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "އެންވަޔަރަމެންޓް ވެރިއަބަލް",
  "settings.mcp.form.headers": "ހެޑަރ",
  "settings.mcp.form.addRow": "ރޮން އިތުރު",
  "settings.mcp.form.removeRow": "ފުރައި",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ކްލައިންޓް ID",
  "settings.mcp.form.oauth.clientSecret": "ކްލައިންޓް ސީކްރެޓް",
  "settings.mcp.form.oauth.clientSecret.keep": "ފުއްވައި ދޫކުރުމަށް — އަލުން އެންތެންޓިކޭޓް ކުރަން ޖެހޭކަން ހުއްޓި",
  "settings.mcp.form.oauth.scope": "ސްކޯޕް",
  "settings.mcp.form.oauth.callbackPort": "ކޯލްބެކް ޕޯޓް",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth އޮޓޯ-ޑިޓެކްޝަން އޮފް ކުރޭ",
  "settings.mcp.form.enabled": "އޮން",
  "settings.mcp.form.timeout": "ޓައިމްއައުޓް (ms)",
  "settings.mcp.form.save": "ސޭވް",
  "settings.mcp.form.cancel": "ކެންސަލް",
  "settings.mcp.form.error.name": "ނަން ލިޔުމުން ކުރޭ.",
  "settings.mcp.form.error.command": "ކޮމާންޑް ލިޔުމުން ކުރޭ.",
  "settings.mcp.form.error.url": "URL ލިޔުމުން ކުރޭ.",
  "settings.mcp.form.error.callbackPort": "ކޯލްބެކް ޕޯޓް 1-65535 އާދެ ހުންނަން ޖެހޭ.",
  "settings.mcp.form.error.timeout": "ޓައިމްއައުޓް ޕޮޒިޓިވް އިންޓިޖަރ ވަން ޖެހޭ.",
  "settings.mcp.errors.invalid": "ހައިލައިޓް ކުރެވިފައިވާ ފީލްޑް ތަންފީސް ކުރޭ.",
  "settings.mcp.errors.duplicate": "މި ނަންގައި ސަރވަރ ހުރިން އެބަހުއެވެ.",
  "settings.mcp.errors.noConfig": "{{name}} ގެ ކޮންފިގް ކިޔަން ނުޖެހޭ — ޕްރޮޖެކްޓް ބޭރުން ކަނޑައެޅިފައި ހުރިކަން ހުއްޓި.",
  "settings.mcp.edit.warn": "ސޭވް ކުރުމުން މި ސަރވަރ އަލަށް ގުޅޭ.",
  ...
  "settings.plugins.detail.copied": "ކޮޕީ ކުރެވިފައި",
  "settings.plugins.detail.notOnNpm": "npm ގައި ނުފެންނާ — opencode.json އަށް ތަކުރުފާރު ގޮތުގައި އިތުރުކުރޭ",
  "settings.plugins.install.title": "ޕްލަގިން އެންސެލް",
  "settings.plugins.install.description": "{{name}} ކުރީގެ ކަން އިތުރުކުރާނީ؟",
  "settings.plugins.install.global": "ގްލޯބަލް (~/.config/opencode)",
  "settings.plugins.install.project": "މިސްރަސްތުގައި",
  "settings.plugins.install.cancel": "ކެންސަލް",
  "settings.plugins.install.success": "{{name}} އެންސެލްވީ. ލޯޑް ކުރުމަށް OpenCode އަލަށް ފައްޅާލާށި.",
  "settings.plugins.installed.empty": "އެންސެލްވެފައިވާ ޕްލަގިން ނުވޭނީ.",
  "settings.plugins.installed.provenance.global": "ގްލޯބަލް",
  "settings.plugins.installed.provenance.project": "މިސްރަސް",
  ...
  "settings.plugins.errors.catalog": "ތަބައިކޮށް ހުރީ",
  "settings.plugins.stale": "ކެޗް ކުރެވިފައިވާ ކެޓަލޮގު ދައްކާށެވެ ({{age}} ކުރީގެ).",
