...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "asiakkaan rekisteröinti vaaditaan",
  "mcp.status.pending": "yhdistetään…",
  ...
  "settings.plugins.section.browse": "Selaa",
  "settings.plugins.section.installed": "Asennettu",
  ...
  "settings.mcp.add": "Lisää palvelin",
  "settings.mcp.type.local": "Paikallinen",
  "settings.mcp.type.remote": "Etä",
  "settings.mcp.empty": "Yhtään MCP-palvelinta ei ole määritetty.",
  "settings.mcp.deleted": "{{name}} poistettu.",
  "settings.mcp.errors.refresh": "MCP-palvelimia ei voitu ladata.",
  "settings.mcp.status.pending": "yhdistetään…",
  "settings.mcp.action.connect": "Yhdistä",
  "settings.mcp.action.disconnect": "Katkaise yhteys",
  "settings.mcp.action.authenticate": "Todenna",
  "settings.mcp.action.edit": "Muokkaa",
  "settings.mcp.action.delete": "Poista",
  "settings.mcp.delete.title": "Poista MCP-palvelin",
  "settings.mcp.delete.body": "Poistetaanko {{name}}? Tätä ei voi kumota.",
  "settings.mcp.form.title.add": "Lisää MCP-palvelin",
  "settings.mcp.form.title.edit": "Muokkaa MCP-palvelinta",
  "settings.mcp.form.subtitle": "Määritä yhteysasetukset.",
  "settings.mcp.form.name": "Nimi",
  "settings.mcp.form.command": "Komento",
  "settings.mcp.form.command.hint": "esim. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Työhakemisto",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Ympäristömuuttujat",
  "settings.mcp.form.headers": "Otsikot",
  "settings.mcp.form.addRow": "Lisää rivi",
  "settings.mcp.form.removeRow": "Poista",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Jätä tyhjäksi ohittaaksesi — uudelleentodennus voi olla tarpeen",
  "settings.mcp.form.oauth.scope": "Laajuus",
  "settings.mcp.form.oauth.callbackPort": "Takaisinkutsuportti",
  "settings.mcp.form.oauth.disableAutodetect": "Poista OAuth-automaattitunnistus",
  "settings.mcp.form.enabled": "Käytössä",
  "settings.mcp.form.timeout": "Aikakatkaisu (ms)",
  "settings.mcp.form.save": "Tallenna",
  "settings.mcp.form.cancel": "Peruuta",
  "settings.mcp.form.error.name": "Anna nimi.",
  "settings.mcp.form.error.command": "Anna komento.",
  "settings.mcp.form.error.url": "Anna URL.",
  "settings.mcp.form.error.callbackPort": "Takaisinkutsuportin on oltava 1–65535.",
  "settings.mcp.form.error.timeout": "Aikakatkaisun on oltava positiivinen kokonaisluku.",
  "settings.mcp.errors.invalid": "Korjaa korostetut kentät.",
  "settings.mcp.errors.duplicate": "Tällä nimellä on jo palvelin.",
  "settings.mcp.errors.noConfig": "Konfiguraatiota {{name}} ei voi lukea — se voi olla määritetty projektin ulkopuolella.",
  "settings.mcp.edit.warn": "Tallentaminen yhdistää palvelimen uudelleen.",
  ...
  "settings.plugins.detail.copied": "Kopioitu",
  "settings.plugins.detail.notOnNpm": "Ei löytynyt npm:stä — lisää manuaalisesti opencode.json-tiedostoon",
  "settings.plugins.install.title": "Asenna liitännäinen",
  "settings.plugins.install.description": "Mihin {{name}} lisätään?",
  "settings.plugins.install.global": "Globaali (~/.config/opencode)",
  "settings.plugins.install.project": "Tämä projekti",
  "settings.plugins.install.cancel": "Peruuta",
  "settings.plugins.install.success": "{{name}} asennettu. Käynnistä OpenCode uudelleen ladataksesi sen.",
  "settings.plugins.installed.empty": "Liitännäisiä ei ole asennettu.",
  "settings.plugins.installed.provenance.global": "Globaali",
  "settings.plugins.installed.provenance.project": "Projekti",
  ...
  "settings.plugins.errors.catalog": "Liitännäisluetteloa ei voitu päivittää.",
  "settings.plugins.stale": "Näytetään välimuistissa oleva luettelo ({{age}} vanha).",
