...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "skráning av viðskiftara kravd",
  "mcp.status.pending": "knýtir…",
  ...
  "settings.tab.plugins": "Íviðkanir",
  "settings.plugins.section.browse": "Kagja",
  "settings.plugins.section.installed": "Uppsett leitan",
  "settings.plugins.source.all": "Allar keldur",
  "settings.plugins.source.ecosystem": "Økosystem",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Legg afturat ambætari",
  "settings.mcp.type.local": "Staðvíst",
  "settings.mcp.type.remote": "Fjarlægt",
  "settings.mcp.empty": "Ongin MCP-ambætarar uppsett.",
  "settings.mcp.deleted": "{{name}} strikað.",
  "settings.mcp.errors.refresh": "Kundi ikki lesa MCP-ambætara.",
  "settings.mcp.status.pending": "knýtir…",
  "settings.mcp.action.connect": "Knýttu til",
  "settings.mcp.action.disconnect": "Fjalknýtta",
  "settings.mcp.action.authenticate": "Góðkenn",
  "settings.mcp.action.edit": "Broyt",
  "settings.mcp.action.delete": "Strika",
  "settings.mcp.delete.title": "Strika MCP-ambætarin",
  "settings.mcp.delete.body": "Tak {{name}} burtur? Hetta kann ikki gerast aftur.",
  "settings.mcp.form.title.add": "Legg MCP-ambætari afturat",
  "settings.mcp.form.title.edit": "Broyt MCP-ambætara",
  "settings.mcp.form.subtitle": "Set sambindingarstillingarnar.",
  "settings.mcp.form.name": "Navn",
  "settings.mcp.form.command": "Boð",
  "settings.mcp.form.command.hint": "t.d. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Arbeidsmappi",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Umhvørvisbroytarar",
  "settings.mcp.form.headers": "Høvd",
  "settings.mcp.form.addRow": "Legg linju afturat",
  "settings.mcp.form.removeRow": "Tak burtur",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Klient-ID",
  "settings.mcp.form.oauth.clientSecret": "Klient-loyndarmál",
  "settings.mcp.form.oauth.clientSecret.keep": "Lat tómt fyri at sleppa — nýggj góðkenn kann vera neyðug",
  "settings.mcp.form.oauth.scope": "Náttúr",
  "settings.mcp.form.oauth.callbackPort": "Afturkallsportur",
  "settings.mcp.form.oauth.disableAutodetect": "Sløkk sjálvgrundlegging av OAuth",
  "settings.mcp.form.enabled": "Virkin",
  "settings.mcp.form.timeout": "Tíðaravmark (ms)",
  "settings.mcp.form.save": "Goym",
  "settings.mcp.form.cancel": "Avlýs",
  "settings.mcp.form.error.name": "Skriva eitt navn.",
  "settings.mcp.form.error.command": "Skriva eitt boð.",
  "settings.mcp.form.error.url": "Skriva ein URL.",
  "settings.mcp.form.error.callbackPort": "Afturkallsporturin má vera millum 1 og 65535.",
  "settings.mcp.form.error.timeout": "Tíðaravmarkið má vera eitt positivt heiltal.",
  "settings.mcp.errors.invalid": "Rættað tey undirstrikaðu teigini.",
  "settings.mcp.errors.duplicate": "Ambætari við hesum navni er longu til.",
  "settings.mcp.errors.noConfig": "Kundi ikki lesa uppsetingina fyri {{name}} — kanska ásett uttanfyri verkætlanina.",
  "settings.mcp.edit.warn": "At goyma knýt ambætaran aftur.",
  "settings.plugins.search.placeholder": "Leita eftir íviðkunum…",
  "settings.plugins.detail.install": "Set upp…",
  "settings.plugins.detail.copy": "Avrita uppsetingarbrot",
  "settings.plugins.detail.copied": "Avritað",
  "settings.plugins.detail.notOnNpm": "Finst ikki á npm — leggst afturat manuelt í opencode.json",
  "settings.plugins.install.title": "Set íviðkan upp",
  "settings.plugins.install.description": "Hvar skal {{name}} leggjast afturat?",
  "settings.plugins.install.global": "Fyri alt (~/.config/opencode)",
  "settings.plugins.install.project": "Hendan verkætlanin",
  "settings.plugins.install.cancel": "Angra",
  "settings.plugins.install.success": "{{name}} er uppsett. Tak OpenCode aftur at fyri at lesa tað.",
  "settings.plugins.installed.empty": "Eingnar íviðkanir uppsettar.",
  "settings.plugins.installed.provenance.global": "Fyri alt",
  "settings.plugins.installed.provenance.project": "Verkætlan",
  ...
  "settings.plugins.errors.catalog": "Kann ikki dagføra íviðkanauppskrift.",
  "settings.plugins.stale": "Vísir úr skjóti ({{age}} gamalt).",
