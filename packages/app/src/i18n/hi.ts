export const dict = {
  ...
  "mcp.status.needs_client_registration": "क्लाइंट पंजीकरण आवश्यक",
  "mcp.status.pending": "जुड़ रहे हैं…",
  ...
  "settings.plugins.section.browse": "ब्राउज़",
  "settings.plugins.section.installed": "इंस्टॉल किए गए",
  "settings.plugins.source.all": "सभी स्रोत",
  "settings.plugins.source.ecosystem": "इकोसिस्टम",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "सर्वर जोड़ें",
  "settings.mcp.type.local": "लोकल",
  "settings.mcp.type.remote": "रिमोट",
  "settings.mcp.empty": "कोई MCP सर्वर कॉन्फ़िगर नहीं है।",
  "settings.mcp.deleted": "{{name}} हटा दिया गया।",
  "settings.mcp.errors.refresh": "MCP सर्वर लोड नहीं हो सके।",
  "settings.mcp.status.pending": "जुड़ रहे हैं…",
  "settings.mcp.action.connect": "कनेक्ट करें",
  "settings.mcp.action.disconnect": "डिस्कनेक्ट करें",
  "settings.mcp.action.authenticate": "प्रमाणित करें",
  "settings.mcp.action.edit": "संपादित करें",
  "settings.mcp.action.delete": "हटाएँ",
  "settings.mcp.delete.title": "MCP सर्वर हटाएँ",
  "settings.mcp.delete.body": "{{name}} हटाएँ? यह पूर्ववत नहीं किया जा सकता।",
  "settings.mcp.form.title.add": "MCP सर्वर जोड़ें",
  "settings.mcp.form.title.edit": "MCP सर्वर संपादित करें",
  "settings.mcp.form.subtitle": "कनेक्शन सेटिंग्स कॉन्फ़िगर करें।",
  "settings.mcp.form.name": "नाम",
  "settings.mcp.form.command": "कमांड",
  "settings.mcp.form.command.hint": "उदा. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "कार्यशील निर्देशिका",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "पर्यावरण चर",
  "settings.mcp.form.headers": "हेडर",
  "settings.mcp.form.addRow": "पंक्ति जोड़ें",
  "settings.mcp.form.removeRow": "हटाएँ",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "क्लाइंट ID",
  "settings.mcp.form.oauth.clientSecret": "क्लाइंट सीक्रेट",
  "settings.mcp.form.oauth.clientSecret.keep": "छोड़ने के लिए खाली रखें — दोबारा प्रमाणीकरण आवश्यक हो सकता है",
  "settings.mcp.form.oauth.scope": "स्कोप",
  "settings.mcp.form.oauth.callbackPort": "कॉलबैक पोर्ट",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth ऑटो-डिटेक्शन अक्षम करें",
  "settings.mcp.form.enabled": "सक्षम",
  "settings.mcp.form.timeout": "टाइमआउट (ms)",
  "settings.mcp.form.save": "सहेजें",
  "settings.mcp.form.cancel": "रद्द करें",
  "settings.mcp.form.error.name": "नाम दर्ज करें।",
  "settings.mcp.form.error.command": "कमांड दर्ज करें।",
  "settings.mcp.form.error.url": "URL दर्ज करें।",
  "settings.mcp.form.error.callbackPort": "कॉलबैक पोर्ट 1 से 65535 के बीच होना चाहिए।",
  "settings.mcp.form.error.timeout": "टाइमआउट एक धनात्मक पूर्णांक होना चाहिए।",
  "settings.mcp.errors.invalid": "हाइलाइट किए गए फ़ील्ड ठीक करें।",
  "settings.mcp.errors.duplicate": "इस नाम का सर्वर पहले से मौजूद है।",
  "settings.mcp.errors.noConfig": "{{name}} की कॉन्फ़िगरेशन पढ़ी नहीं जा सकी — प्रोजेक्ट के बाहर परिभाषित हो सकती है।",
  "settings.mcp.edit.warn": "सहेजने से यह सर्वर फिर से कनेक्ट होगा।",
  "settings.plugins.search.placeholder": "प्लगइन खोजें…",
  "settings.plugins.detail.install": "इंस्टॉल करें…",
  "settings.plugins.detail.copy": "कॉन्फ़िग स्निपेट कॉपी करें",
  "settings.plugins.detail.copied": "कॉपी किया गया",
  "settings.plugins.detail.notOnNpm": "npm पर नहीं मिला — opencode.json में मैन्युअली जोड़ें",
  "settings.plugins.install.title": "प्लगइन इंस्टॉल करें",
  "settings.plugins.install.description": "{{name}} को कहाँ जोड़ा जाए?",
  "settings.plugins.install.global": "ग्लोबल (~/.config/opencode)",
  "settings.plugins.install.project": "यह प्रोजेक्ट",
  "settings.plugins.install.cancel": "रद्द करें",
  "settings.plugins.install.success": "{{name}} इंस्टॉल हो गया। लोड करने के लिए OpenCode पुनः शुरू करें।",
  "settings.plugins.installed.empty": "कोई प्लगइन इंस्टॉल नहीं है।",
  "settings.plugins.installed.provenance.global": "ग्लोबल",
  "settings.plugins.installed.provenance.project": "प्रोजेक्ट",
  ...
  "settings.plugins.errors.catalog": "प्लगइन कैटलॉग रिफ्रेश नहीं हो सका।",
  "settings.plugins.stale": "कैश किया गया कैटलॉग दिखा रहे हैं ({{age}} पुराना)।",
