...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "skráning viðskiptavinar krafist",
  "mcp.status.pending": "tengist…",
  ...
  "settings.tab.plugins": "Viðbætur",
  "settings.plugins.section.browse": "Flakka",
  "settings.plugins.section.installed": "Uppsettar",
  ...
  "settings.mcp.add": "Bæta við þjóni",
  "settings.mcp.type.local": "Staðbundið",
  "settings.mcp.type.remote": "Fjartengt",
  "settings.mcp.empty": "Engir MCP-þjónar stilltir.",
  "settings.mcp.deleted": "{{name}} eytt.",
  "settings.mcp.errors.refresh": "Mistókst að hlaða MCP-þjónum.",
  "settings.mcp.status.pending": "tengist…",
  "settings.mcp.action.connect": "Tengjast",
  "settings.mcp.action.disconnect": "Aftengjast",
  "settings.mcp.action.authenticate": "Auðkenna",
  "settings.mcp.action.edit": "Breyta",
  "settings.mcp.action.delete": "Eyða",
  "settings.mcp.delete.title": "Eyða MCP-þjóni",
  "settings.mcp.delete.body": "Fjarlægja {{name}}? Þetta er ekki hægt að afturkalla.",
  "settings.mcp.form.title.add": "Bæta við MCP-þjóni",
  "settings.mcp.form.title.edit": "Breyta MCP-þjóni",
  "settings.mcp.form.subtitle": "Stilltu tengistillingarnar.",
  "settings.mcp.form.name": "Heiti",
  "settings.mcp.form.command": "Skipun",
  "settings.mcp.form.command.hint": "t.d. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Vinnuskrá",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Umhverfisbreytur",
  "settings.mcp.form.headers": "Fyrirsagnir",
  "settings.mcp.form.addRow": "Bæta við röð",
  "settings.mcp.form.removeRow": "Fjarlægja",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Biðlaraauðkenni",
  "settings.mcp.form.oauth.clientSecret": "Biðarleyndarmál",
  "settings.mcp.form.oauth.clientSecret.keep": "Skildu tómt til að sleppa — endurauðkenning getur verið nauðsynleg",
  "settings.mcp.form.oauth.scope": "Umfang",
  "settings.mcp.form.oauth.callbackPort": "Afturkallsport",
  "settings.mcp.form.oauth.disableAutodetect": "Slökkva á sjálfvirkri OAuth-þekkingu",
  "settings.mcp.form.enabled": "Virkt",
  "settings.mcp.form.timeout": "Tímamörk (ms)",
  "settings.mcp.form.save": "Vista",
  "settings.mcp.form.cancel": "Hætta við",
  "settings.mcp.form.error.name": "Sláðu inn heiti.",
  "settings.mcp.form.error.command": "Sláðu inn skipun.",
  "settings.mcp.form.error.url": "Sláðu inn URL.",
  "settings.mcp.form.error.callbackPort": "Afturkallsport verður að vera 1–65535.",
  "settings.mcp.form.error.timeout": "Tímamörk verða að vera jákvæð heiltala.",
  "settings.mcp.errors.invalid": "Lagðu úr lituðu svæðunum.",
  "settings.mcp.errors.duplicate": "Þjónn með þessu heiti er þegar til.",
  "settings.mcp.errors.noConfig": "Get ekki lesið stillingar fyrir {{name}} — gætu verið skilgreindar utan verkefnisins.",
  "settings.mcp.edit.warn": "Vistun endirtengir þennan þjón.",
  ...
  "settings.plugins.detail.copied": "Afritað",
  "settings.plugins.detail.notOnNpm": "Fannst ekki á npm — bættu handvirkt í opencode.json",
  "settings.plugins.install.title": "Setja upp viðbót",
  "settings.plugins.install.description": "Hvar á að bæta {{name}} við?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Þetta verkefni",
  "settings.plugins.install.cancel": "Hætta við",
  "settings.plugins.install.success": "{{name}} uppsett. Endurræstu OpenCode til að hlaupa það inn.",
  "settings.plugins.installed.empty": "Engar viðbætur uppsettar.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Verkefni",
  ...
  "settings.plugins.errors.catalog": "Gat ekki endurhlaðað viðbótarskrá.",
  "settings.plugins.stale": "Birtir skyndiminni útgáfu ({{age}} gömul).",
