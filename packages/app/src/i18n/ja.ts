...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "クライアント登録が必要",
  "mcp.status.pending": "接続中…",
  ...
  "settings.plugins.section.browse": "参照",
  ...
  "settings.mcp.empty": "設定されたMCPサーバーはありません。",
  "settings.mcp.deleted": "{{name}} を削除しました。",
  "settings.mcp.errors.refresh": "MCPサーバーを読み込めませんでした。",
  "settings.mcp.status.pending": "接続中…",
  "settings.mcp.action.connect": "接続",
  "settings.mcp.action.disconnect": "切断",
  "settings.mcp.action.authenticate": "認証",
  "settings.mcp.action.edit": "編集",
  "settings.mcp.action.delete": "削除",
  "settings.mcp.delete.title": "MCPサーバーを削除",
  "settings.mcp.delete.body": "{{name}} を削除しますか？元に戻せません。",
  "settings.mcp.form.title.add": "MCPサーバーを追加",
  "settings.mcp.form.title.edit": "MCPサーバーを編集",
  "settings.mcp.form.subtitle": "接続設定を構成します。",
  "settings.mcp.form.name": "名前",
  "settings.mcp.form.command": "コマンド",
  "settings.mcp.form.command.hint": "例: npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "作業ディレクトリ",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "環境変数",
  "settings.mcp.form.headers": "ヘッダー",
  "settings.mcp.form.addRow": "行を追加",
  "settings.mcp.form.removeRow": "削除",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "クライアントID",
  "settings.mcp.form.oauth.clientSecret": "クライアントシークレット",
  "settings.mcp.form.oauth.clientSecret.keep": "空欄のままにすると省略されます — 再認証が必要になる場合があります",
  "settings.mcp.form.oauth.scope": "スコープ",
  "settings.mcp.form.oauth.callbackPort": "コールバックポート",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth自動検出を無効化",
  "settings.mcp.form.enabled": "有効",
  "settings.mcp.form.timeout": "タイムアウト (ms)",
  "settings.mcp.form.save": "保存",
  "settings.mcp.form.cancel": "キャンセル",
  "settings.mcp.form.error.name": "名前を入力してください。",
  "settings.mcp.form.error.command": "コマンドを入力してください。",
  "settings.mcp.form.error.url": "URLを入力してください。",
  "settings.mcp.form.error.callbackPort": "コールバックポートは1〜65535の数値である必要があります。",
  "settings.mcp.form.error.timeout": "タイムアウトは正の整数である必要があります。",
  "settings.mcp.errors.invalid": "強調表示されたフィールドを修正してください。",
  "settings.mcp.errors.duplicate": "この名前のサーバーは既に存在します。",
  "settings.mcp.errors.noConfig": "{{name}} の設定を読み取れません — プロジェクト外で定義されている可能性があります。",
  "settings.mcp.edit.warn": "保存するとこのサーバーに再接続します。",
  ...
  "settings.plugins.detail.copied": "コピーしました",
  "settings.plugins.detail.notOnNpm": "npm に見つかりません — opencode.json に手動で追加してください",
  "settings.plugins.install.title": "プラグインをインストール",
  "settings.plugins.install.description": "{{name}} をどこに追加しますか？",
  "settings.plugins.install.global": "グローバル (~/.config/opencode)",
  "settings.plugins.install.project": "このプロジェクト",
  "settings.plugins.install.cancel": "キャンセル",
  "settings.plugins.install.success": "{{name}} をインストールしました。読み込むには OpenCode を再起動してください。",
  "settings.plugins.installed.empty": "インストールされたプラグインはありません。",
  "settings.plugins.installed.provenance.global": "グローバル",
  "settings.plugins.installed.provenance.project": "プロジェクト",
  ...
  "settings.plugins.errors.catalog": "プラグインカタログを更新できませんでした。",
  "settings.plugins.stale": "キャッシュされたカタログを表示中（{{age}} 前のもの）。",
