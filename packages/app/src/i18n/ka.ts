export const dict = {
  ...
  "mcp.status.needs_client_registration": "საჭიროა კლიენტის რეგისტრაცია",
  "mcp.status.pending": "დაკავშირება…",
  ...
  "settings.tab.plugins": "პლაგინები",
  "settings.plugins.section.browse": "დათვალიერება",
  "settings.plugins.section.installed": "დაინსტალირებული",
  ...
  "settings.mcp.add": "სერვერის დამატება",
  "settings.mcp.type.local": "ლოკალური",
  "settings.mcp.type.remote": "დაშორებული",
  "settings.mcp.empty": "MCP სერვერები კონფიგურირებული არაა.",
  "settings.mcp.deleted": "{{name}} წაიშალა.",
  "settings.mcp.errors.refresh": "MCP სერვერების ჩატვირთვა ვერ მოხერხდა.",
  "settings.mcp.status.pending": "დაკავშირება…",
  "settings.mcp.action.connect": "დაკავშირება",
  "settings.mcp.action.disconnect": "გათიშვა",
  "settings.mcp.action.authenticate": "ავთენტიფიკაცია",
  "settings.mcp.action.edit": "რედაქტირება",
  "settings.mcp.action.delete": "წაშლა",
  "settings.mcp.delete.title": "MCP სერვერის წაშლა",
  "settings.mcp.delete.body": "წაიშალოს {{name}}? ეს ქმედება გაუქმებადი არაა.",
  "settings.mcp.form.title.add": "MCP სერვერის დამატება",
  "settings.mcp.form.title.edit": "MCP სერვერის რედაქტირება",
  "settings.mcp.form.subtitle": "მოარტე კავშირის პარამეტრები.",
  "settings.mcp.form.name": "სახელი",
  "settings.mcp.form.command": "ბრძანება",
  "settings.mcp.form.command.hint": "მაგ. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "სამუშაო საქაღალდე",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "გარემოს ცვლადები",
  "settings.mcp.form.headers": "სათაურები",
  "settings.mcp.form.addRow": "სტრიქონის დამატება",
  "settings.mcp.form.removeRow": "ამოღება",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "კლიენტის ID",
  "settings.mcp.form.oauth.clientSecret": "კლიენტის საიდუმლო",
  "settings.mcp.form.oauth.clientSecret.keep": "გამოსატოვებლად დატოვეთ ცარიელი — შესაძლოა ხელახალი აუთენთიფიკაცია დასჭირდეს",
  "settings.mcp.form.oauth.scope": "სფერო",
  "settings.mcp.form.oauth.callbackPort": "კოლბექის პორტი",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth-ის ავტომატური ამოცნობის გამორთვა",
  "settings.mcp.form.enabled": "ჩართულია",
  "settings.mcp.form.timeout": "ვადა (ms)",
  "settings.mcp.form.save": "შენახვა",
  "settings.mcp.form.cancel": "გაუქმება",
  "settings.mcp.form.error.name": "შეიყვანეთ სახელი.",
  "settings.mcp.form.error.command": "შეიყვანეთ ბრძანება.",
  "settings.mcp.form.error.url": "შეიყვანეთ URL.",
  "settings.mcp.form.error.callbackPort": "კოლბექის პორტი უნდა იყოს 1-65535.",
  "settings.mcp.form.error.timeout": "ვადა უნდა იყოს დადებითი მთელი რიცხვი.",
  "settings.mcp.errors.invalid": "გაასწორეთ მონიშნული ველები.",
  "settings.mcp.errors.duplicate": "ამ სახელით სერვერი უკვე არსებობს.",
  "settings.mcp.errors.noConfig": "{{name}}-ის კონფიგურაციის წაკითხვა შეუძლებელია — შესაძლოა პროექტის ფარგლებს გარეთაა.",
  "settings.mcp.edit.warn": "შენახვა ხელახლა აკავშირებს სერვერს.",
  ...
  "settings.plugins.detail.copied": "დაკოპირდა",
  "settings.plugins.detail.notOnNpm": "npm-ზე ვერ მოიძებნა — ხელით დაამატეთ opencode.json-ში",
  "settings.plugins.install.title": "პლაგინის ინსტალაცია",
  "settings.plugins.install.description": "სად დაემატოს {{name}}?",
  "settings.plugins.install.global": "გლობალური (~/.config/opencode)",
  "settings.plugins.install.project": "ეს პროექტი",
  "settings.plugins.install.cancel": "გაუქმება",
  "settings.plugins.install.success": "{{name}} დაინსტალირდა. ჩასატვირთად გადატვირთეთ OpenCode.",
  "settings.plugins.installed.empty": "პლაგინები დაინსტალირებული არაა.",
  "settings.plugins.installed.provenance.global": "გლობალური",
  "settings.plugins.installed.provenance.project": "პროექტი",
  ...
  "settings.plugins.errors.catalog": "პლაგინების კატალოგის განახლება ვერ მოხერხდა.",
  "settings.plugins.stale": "ნაჩვენებია კეშირებული კატალოგი ({{age}}-ის წინ).",
