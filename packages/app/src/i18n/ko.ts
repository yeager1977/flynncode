...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "클라이언트 등록 필요",
  "mcp.status.pending": "연결 중…",
  ...
  "settings.plugins.section.browse": "찾아보기",
  ...
  "settings.mcp.add": "서버 추가",
  "settings.mcp.type.local": "로컬",
  "settings.mcp.type.remote": "원격",
  "settings.mcp.empty": "구성된 MCP 서버가 없습니다.",
  "settings.mcp.deleted": "{{name}} 삭제됨.",
  "settings.mcp.errors.refresh": "MCP 서버를 불러올 수 없습니다.",
  "settings.mcp.status.pending": "연결 중…",
  "settings.mcp.action.connect": "연결",
  "settings.mcp.action.disconnect": "연결 해제",
  "settings.mcp.action.authenticate": "인증",
  "settings.mcp.action.edit": "편집",
  "settings.mcp.action.delete": "삭제",
  "settings.mcp.delete.title": "MCP 서버 삭제",
  "settings.mcp.delete.body": "{{name}}을(를) 제거하시겠습니까? 되돌릴 수 없습니다.",
  "settings.mcp.form.title.add": "MCP 서버 추가",
  "settings.mcp.form.title.edit": "MCP 서버 편집",
  "settings.mcp.form.subtitle": "연결 설정을 구성합니다.",
  "settings.mcp.form.name": "이름",
  "settings.mcp.form.command": "명령",
  "settings.mcp.form.command.hint": "예: npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "작업 디렉터리",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "환경 변수",
  "settings.mcp.form.headers": "헤더",
  "settings.mcp.form.addRow": "행 추가",
  "settings.mcp.form.removeRow": "제거",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "클라이언트 ID",
  "settings.mcp.form.oauth.clientSecret": "클라이언트 시크릿",
  "settings.mcp.form.oauth.clientSecret.keep": "비워 두면 생략됩니다 — 재인증이 필요할 수 있습니다",
  "settings.mcp.form.oauth.scope": "범위",
  "settings.mcp.form.oauth.callbackPort": "콜백 포트",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth 자동 감지 비활성화",
  "settings.mcp.form.enabled": "활성화",
  "settings.mcp.form.timeout": "시간 제한 (ms)",
  "settings.mcp.form.save": "저장",
  "settings.mcp.form.cancel": "취소",
  "settings.mcp.form.error.name": "이름을 입력하세요.",
  "settings.mcp.form.error.command": "명령을 입력하세요.",
  "settings.mcp.form.error.url": "URL을 입력하세요.",
  "settings.mcp.form.error.callbackPort": "콜백 포트는 1~65535 사이의 숫자여야 합니다.",
  "settings.mcp.form.error.timeout": "시간 제한은 양의 정수여야 합니다.",
  "settings.mcp.errors.invalid": "강조된 필드를 수정하세요.",
  "settings.mcp.errors.duplicate": "이 이름의 서버가 이미 있습니다.",
  "settings.mcp.errors.noConfig": "{{name}}의 구성을 읽을 수 없습니다 — 프로젝트 외부에 정의되어 있을 수 있습니다.",
  "settings.mcp.edit.warn": "저장하면 이 서버가 다시 연결됩니다.",
  "settings.plugins.search.placeholder": "플러그인 검색…",
  "settings.plugins.detail.install": "설치…",
  "settings.plugins.detail.copy": "설정 스니펫 복사",
  "settings.plugins.detail.copied": "복사됨",
  "settings.plugins.detail.notOnNpm": "npm에서 찾을 수 없음 — opencode.json에 수동으로 추가하세요",
  "settings.plugins.install.title": "플러그인 설치",
  "settings.plugins.install.description": "{{name}}을(를) 어디에 추가할까요?",
  "settings.plugins.install.global": "전역 (~/.config/opencode)",
  "settings.plugins.install.project": "이 프로젝트",
  "settings.plugins.install.cancel": "취소",
  "settings.plugins.install.success": "{{name}}이(가) 설치되었습니다. 불러오려면 OpenCode를 재시작하세요.",
  "settings.plugins.installed.empty": "설치된 플러그인이 없습니다.",
  "settings.plugins.installed.provenance.global": "전역",
  "settings.plugins.installed.provenance.project": "프로젝트",
  ...
  "settings.plugins.errors.catalog": "플러그인 카탈로그를 새로 고칠 수 없습니다.",
  "settings.plugins.stale": "캐시된 카탈로그 표시 중 ({{age}} 경과).",
