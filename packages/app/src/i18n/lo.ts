...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "ຕ້ອງການລົງທະບຽນລູກຂານ",
  "mcp.status.pending": "ກຳລັງເຊື່ອມຕໍ່…",
  ...
  "settings.plugins.section.browse": "ທ່ອງໄຟ້",
  "settings.plugins.section.installed": "ຕິດຕັ້ງແລ້ວ",
  ...
  "settings.mcp.add": "ເພີ່ມເຊີບເວີ",
  "settings.mcp.type.local": "ທ້ອງຖິ່ນ",
  "settings.mcp.type.remote": "ໄລຍະໄກ",
  "settings.mcp.empty": "ຍັງບໍ່ມີການຕັ້ງຄ່າເຊີບເວີ MCP.",
  "settings.mcp.deleted": "ລຶບ {{name}} ແລ້ວ.",
  "settings.mcp.errors.refresh": "ບໍ່ສາມາດໂຫຼດເຊີບເວີ MCP ໄດ້.",
  "settings.mcp.status.pending": "ກຳລັງເຊື່ອມຕໍ່…",
  "settings.mcp.action.connect": "ເຊື່ອມຕໍ່",
  "settings.mcp.action.disconnect": "ຕັດການເຊື່ອມຕໍ່",
  "settings.mcp.action.authenticate": "ຢືນຢັນຕົວຕົນ",
  "settings.mcp.action.edit": "ແກ້ໄຂ",
  "settings.mcp.action.delete": "ລຶບ",
  "settings.mcp.delete.title": "ລຶບເຊີບເວີ MCP",
  "settings.mcp.delete.body": "ເອົາ {{name}} ອອກ? ບໍ່ສາມາດກູ້ຄືນໄດ້.",
  "settings.mcp.form.title.add": "ເພີ່ມເຊີບເວີ MCP",
  "settings.mcp.form.title.edit": "ແກ້ໄຂເຊີບເວີ MCP",
  "settings.mcp.form.subtitle": "ຕັ້ງຄ່າການເຊື່ອມຕໍ່.",
  "settings.mcp.form.name": "ຊື່",
  "settings.mcp.form.command": "ຄຳສັ່ງ",
  "settings.mcp.form.command.hint": "ເຊັ່ນ npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "ໄດເລັກທອລີ່ເຮັດວຽກ",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "ຕົວແປສະພາບແວດລ້ອມ",
  "settings.mcp.form.headers": "ຫົວຂໍ້",
  "settings.mcp.form.addRow": "ເພີ່ມແຖວ",
  "settings.mcp.form.removeRow": "ລຶບ",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ໄອດີລູ້ຄລາຍເອັນ",
  "settings.mcp.form.oauth.clientSecret": "ຄວາມລັບຄລາຍເອັນ",
  "settings.mcp.form.oauth.clientSecret.keep": "ເພື່ອຂ້າມ ປະລັບມັນໄວ້ຫວ່າງ — ອາດຕ້ອງຢືນຢັນຕົວຕົນໃໝ່",
  "settings.mcp.form.oauth.scope": "ຂອບເຂດ",
  "settings.mcp.form.oauth.callbackPort": "ພອດຄໍ່າກັບ",
  "settings.mcp.form.oauth.disableAutodetect": "ປິດການກວດຈັບ OAuth ອັດຕະໂນມັດ",
  "settings.mcp.form.enabled": "ເປີດໃຊ້",
  "settings.mcp.form.timeout": "ໝົດເວລາ (ms)",
  "settings.mcp.form.save": "ບັນທຶກ",
  "settings.mcp.form.cancel": "ຍົກເລີກ",
  "settings.mcp.form.error.name": "ປ້ອນຊື່.",
  "settings.mcp.form.error.command": "ປ້ອນຄຳສັ່ງ.",
  "settings.mcp.form.error.url": "ປ້ອນ URL.",
  "settings.mcp.form.error.callbackPort": "ພອດຄໍ່າກັບຕ້ອງຢູ່ລະຫວ່າງ 1-65535.",
  "settings.mcp.form.error.timeout": "ໝົດເວລາຕ້ອງເປັນຈຳນວນຖ້ວນບວກ.",
  "settings.mcp.errors.invalid": "ແກ້ໄຂຊ່ອງທີ່ໄຮແສັດ.",
  "settings.mcp.errors.duplicate": "ມີເຊີບເວີຊື່ນີ້ແລ້ວ.",
  "settings.mcp.errors.noConfig": "ບໍ່ສາມາດອ່ານຄໍນຟິກຂອງ {{name}} — ອາດກຳນົດຢູ່ນອກໂຄງການ.",
  "settings.mcp.edit.warn": "ບັນທຶກຈະເຊື່ອມຕໍ່ເຊີບເວີນີ້ຄືນໃໝ່.",
  ...
  "settings.plugins.detail.copied": "ສຳເນົາແລ້ວ",
  "settings.plugins.detail.notOnNpm": "ບໍ່ພົບໃນ npm — ເພີ່ມລົງ opencode.json ດ້ວຍຕົນເອງ",
  "settings.plugins.install.title": "ຕິດຕັ້ງປລັກອິນ",
  "settings.plugins.install.description": "ຈະເພີ່ມ {{name}} ຢູ່ໃສ?",
  "settings.plugins.install.global": "ທົ່ວໄປ (~/.config/opencode)",
  "settings.plugins.install.project": "ໂຄງການນີ້",
  "settings.plugins.install.cancel": "ຍົກເລີກ",
  "settings.plugins.install.success": "ຕິດຕັ້ງ {{name}} ແລ້ວ. ຣີສຕາດ OpenCode ເພື່ອໂຫຼດ.",
  "settings.plugins.installed.empty": "ບໍ່ມີປລັກອິນທີ່ຕິດຕັ້ງ.",
  "settings.plugins.installed.provenance.global": "ທົ່ວໄປ",
  "settings.plugins.installed.provenance.project": "ໂຄງການ",
  ...
  "settings.plugins.errors.catalog": "ບໍ່ສາມາດຣີເຟຣຊບັນຊີປລັກອິນໄດ້",
  "settings.plugins.stale": "ສະແດງບັນຊີຈາກແຄຊ (ເກົ່າ {{age}})",
