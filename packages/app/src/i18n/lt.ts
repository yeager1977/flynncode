...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "reikia kliento registracijos",
  "mcp.status.pending": "jungiamasi…",
  ...
  "settings.tab.plugins": "Įskiepiai",
  "settings.plugins.section.browse": "Naršyti",
  "settings.plugins.section.installed": "Įdiegta",
  ...
  "settings.mcp.add": "Pridėti serverį",
  "settings.mcp.type.local": "Vietinis",
  "settings.mcp.type.remote": "Nuotolinis",
  "settings.mcp.empty": "Nėra sukonfigūruotų MCP serverių.",
  "settings.mcp.deleted": "{{name}} ištrintas.",
  "settings.mcp.errors.refresh": "Nepavyko įkelti MCP serverių.",
  "settings.mcp.status.pending": "jungiamasi…",
  "settings.mcp.action.connect": "Prisijungti",
  "settings.mcp.action.disconnect": "Atsijungti",
  "settings.mcp.action.authenticate": "Autentifikuoti",
  "settings.mcp.action.edit": "Redaguoti",
  "settings.mcp.action.delete": "Šalinti",
  "settings.mcp.delete.title": "Ištrinti MCP serverį",
  "settings.mcp.delete.body": "Pašalinti {{name}}? Šio veiksmo negalima atšaukti.",
  "settings.mcp.form.title.add": "Pridėti MCP serverį",
  "settings.mcp.form.title.edit": "Redaguoti MCP serverį",
  "settings.mcp.form.subtitle": "Konfigūruokite ryšio parametrus.",
  "settings.mcp.form.name": "Pavadinimas",
  "settings.mcp.form.command": "Komanda",
  "settings.mcp.form.command.hint": "pvz. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Darbo katalogas",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Aplinkos kintamieji",
  "settings.mcp.form.headers": "Antraštės",
  "settings.mcp.form.addRow": "Pridėti eilutę",
  "settings.mcp.form.removeRow": "Pašalinti",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Kliento ID",
  "settings.mcp.form.oauth.clientSecret": "Kliento paslaptis",
  "settings.mcp.form.oauth.clientSecret.keep": "Palikite tuščią, kad praleistumėte — gali prireikti prisijungti iš naujo",
  "settings.mcp.form.oauth.scope": "Apimtis",
  "settings.mcp.form.oauth.callbackPort": "Atšaukimo prievadas",
  "settings.mcp.form.oauth.disableAutodetect": "Išjungti automatinį OAuth aptikimą",
  "settings.mcp.form.enabled": "Įjungta",
  "settings.mcp.form.timeout": "Skiriamasis laikas (ms)",
  "settings.mcp.form.save": "Išsaugoti",
  "settings.mcp.form.cancel": "Atšaukti",
  "settings.mcp.form.error.name": "Įveskite pavadinimą.",
  "settings.mcp.form.error.command": "Įveskite komandą.",
  "settings.mcp.form.error.url": "Įveskite URL.",
  "settings.mcp.form.error.callbackPort": "Atšaukimo prievadas turi būti 1–65535.",
  "settings.mcp.form.error.timeout": "Skiriamasis laikas turi būti teigiamas sveikasis skaičius.",
  "settings.mcp.errors.invalid": "Ištaisykite pažymėtus laukus.",
  "settings.mcp.errors.duplicate": "Serveris tokiu pavadinimu jau egzistuoja.",
  "settings.mcp.errors.noConfig": "Nepavyksta perskaityti {{name}} konfigūracijos — gali būti apibrėžta už projekto ribų.",
  "settings.mcp.edit.warn": "Išsaugojus serveris bus iš naujo prijungtas.",
  ...
  "settings.plugins.detail.copied": "Nukopijuota",
  "settings.plugins.detail.notOnNpm": "Nerasta npm — pridėkite rankiniu būdu į opencode.json",
  "settings.plugins.install.title": "Įdiegti įskiepį",
  "settings.plugins.install.description": "Kur pridėti {{name}}?",
  "settings.plugins.install.global": "Globalu (~/.config/opencode)",
  "settings.plugins.install.project": "Šis projektas",
  "settings.plugins.install.cancel": "Atšaukti",
  "settings.plugins.install.success": "{{name}} įdiegtas. Įkelti iš naujo paleiskite OpenCode.",
  "settings.plugins.installed.empty": "Nėra įdiegtų įskiepių.",
  "settings.plugins.installed.provenance.global": "Globalus",
  "settings.plugins.installed.provenance.project": "Projektas",
  ...
  "settings.plugins.errors.catalog": "Nepavyko atnaujinti įskiepių katalogo.",
  "settings.plugins.stale": "Rodomas podėlyje saugomas katalogas ({{age}} senas).",
