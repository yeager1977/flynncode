...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "nepieciešama klienta reģistrācija",
  "mcp.status.pending": "savienojas…",
  ...
  "settings.tab.plugins": "Spraudņi",
  "settings.plugins.section.browse": "Pārlūkot",
  "settings.plugins.section.installed": "Uzstādītie",
  ...
  "settings.mcp.add": "Pievienot serveri",
  "settings.mcp.type.local": "Lokāls",
  "settings.mcp.type.remote": "Attālināts",
  "settings.mcp.empty": "Nav konfigurētu MCP serveru.",
  "settings.mcp.deleted": "{{name}} dzēsts.",
  "settings.mcp.errors.refresh": "Nevar ielādēt MCP serverus.",
  "settings.mcp.status.pending": "savienojas…",
  "settings.mcp.action.connect": "Izveidot savienojumu",
  "settings.mcp.action.disconnect": "Pārtraukt savienojumu",
  "settings.mcp.action.authenticate": "Autentificēt",
  "settings.mcp.action.edit": "Labot",
  "settings.mcp.action.delete": "Dzēst",
  "settings.mcp.delete.title": "Dzēst MCP serveri",
  "settings.mcp.delete.body": "Noņemt {{name}}? Šo darbību nevar atsaukt.",
  "settings.mcp.form.title.add": "Pievienot MCP serveri",
  "settings.mcp.form.title.edit": "Rediģēt MCP serveri",
  "settings.mcp.form.subtitle": "Konfigurējiet savienojuma iestatījumus.",
  "settings.mcp.form.name": "Nosaukums",
  "settings.mcp.form.command": "Komanda",
  "settings.mcp.form.command.hint": "piem. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Darba direktorijs",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Vides mainīgie",
  "settings.mcp.form.headers": "Galvenes",
  "settings.mcp.form.addRow": "Pievienot rindu",
  "settings.mcp.form.removeRow": "Noņemt",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Klienta ID",
  "settings.mcp.form.oauth.clientSecret": "Klienta noslēpums",
  "settings.mcp.form.oauth.clientSecret.keep": "Atstājiet tukšu, lai izlaistu — var būt nepieciešama atkārtota autentifikācija",
  "settings.mcp.form.oauth.scope": "Diapazons",
  "settings.mcp.form.oauth.callbackPort": "Atzvanīšanas ports",
  "settings.mcp.form.oauth.disableAutodetect": "Atspējot OAuth automātisko noteikšanu",
  "settings.mcp.form.enabled": "Ieslēgts",
  "settings.mcp.form.timeout": "Taimauts (ms)",
  "settings.mcp.form.save": "Saglabāt",
  "settings.mcp.form.cancel": "Atcelt",
  "settings.mcp.form.error.name": "Ievadiet nosaukumu.",
  "settings.mcp.form.error.command": "Ievadiet komandu.",
  "settings.mcp.form.error.url": "Ievadiet URL.",
  "settings.mcp.form.error.callbackPort": "Atzvanīšanas portam jābūt no 1 līdz 65535.",
  "settings.mcp.form.error.timeout": "Taimautam jābūt pozitīvam veselam skaitlim.",
  "settings.mcp.errors.invalid": "Labojiet iezīmētos laukus.",
  "settings.mcp.errors.duplicate": "Serveris ar šādu nosaukumu jau pastāv.",
  "settings.mcp.errors.noConfig": "Nevar nolasīt {{name}} konfigurāciju — tā var būt definēta ārpus projekta.",
  "settings.mcp.edit.warn": "Saglabāšana atkārtoti pievieno serveri.",
  ...
  "settings.plugins.detail.copied": "Nokopēts",
  "settings.plugins.detail.notOnNpm": "Nav atrasts npm — pievienojiet manuāli opencode.json",
  "settings.plugins.install.title": "Uzstādīt spraudni",
  "settings.plugins.install.description": "Kur pievienot {{name}}?",
  "settings.plugins.install.global": "Globāli (~/.config/opencode)",
  "settings.plugins.install.project": "Šis projekts",
  "settings.plugins.install.cancel": "Atcelt",
  "settings.plugins.install.success": "{{name}} uzstādīts. Lādēšanai restartējiet OpenCode.",
  "settings.plugins.installed.empty": "Nav uzstādītu spraudņu.",
  "settings.plugins.installed.provenance.global": "Globāls",
  "settings.plugins.installed.provenance.project": "Projekts",
  ...
  "settings.plugins.errors.catalog": "Nevar atjaunināt spraudņu katalogu.",
  "settings.plugins.stale": "Tiek rādīts kešatmiņā saglabāts katalogs ({{age}} sens).",
