...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "потребна е регистрација на клиент",
  "mcp.status.pending": "поврзување…",
  ...
  "settings.tab.plugins": "Додатоци",
  "settings.plugins.section.browse": "Прегледај",
  "settings.plugins.section.installed": "Инсталирани",
  "settings.plugins.source.all": "Сите извори",
  "settings.plugins.source.ecosystem": "Екосистем",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Додади сервер",
  "settings.mcp.type.local": "Локален",
  "settings.mcp.type.remote": "Оддалечен",
  "settings.mcp.empty": "Нема конфигурирани MCP сервери.",
  "settings.mcp.deleted": "{{name}} е избришан.",
  "settings.mcp.errors.refresh": "Не може да се вчитаат MCP серверите.",
  "settings.mcp.status.pending": "поврзување…",
  "settings.mcp.action.connect": "Поврзи",
  "settings.mcp.action.disconnect": "Отповрзи",
  "settings.mcp.action.authenticate": "Автентицирај",
  "settings.mcp.action.edit": "Уреди",
  "settings.mcp.action.delete": "Избриши",
  "settings.mcp.delete.title": "Избриши MCP сервер",
  "settings.mcp.delete.body": "Да се отстрани {{name}}? Ова е неповратно.",
  "settings.mcp.form.title.add": "Додади MCP сервер",
  "settings.mcp.form.title.edit": "Уреди MCP сервер",
  "settings.mcp.form.subtitle": "Конфигурирајте ги поставките за поврзување.",
  "settings.mcp.form.name": "Име",
  "settings.mcp.form.command": "Команда",
  "settings.mcp.form.command.hint": "пр. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Работен директориум",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Променливи на околината",
  "settings.mcp.form.headers": "Заглавија",
  "settings.mcp.form.addRow": "Додади ред",
  "settings.mcp.form.removeRow": "Отстрани",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID на клиент",
  "settings.mcp.form.oauth.clientSecret": "Тајна на клиентот",
  "settings.mcp.form.oauth.clientSecret.keep": "Оставете празно за прескокување — може да биде потребна повторна автентикација",
  "settings.mcp.form.oauth.scope": "Опсег",
  "settings.mcp.form.oauth.callbackPort": "Порт за повратно повикување",
  "settings.mcp.form.oauth.disableAutodetect": "Оневозможи автоматско откривање OAuth",
  "settings.mcp.form.enabled": "Овозможено",
  "settings.mcp.form.timeout": "Време на чекање (ms)",
  "settings.mcp.form.save": "Зачувај",
  "settings.mcp.form.cancel": "Откажи",
  "settings.mcp.form.error.name": "Внесете име.",
  "settings.mcp.form.error.command": "Внесете команда.",
  "settings.mcp.form.error.url": "Внесете URL.",
  "settings.mcp.form.error.callbackPort": "Портот за повратно повикување мора да биде 1–65535.",
  "settings.mcp.form.error.timeout": "Времето на чекање мора да биде позитивен цел број.",
  "settings.mcp.errors.invalid": "Поправете ги означените полиња.",
  "settings.mcp.errors.duplicate": "Веќе постои сервер со ова име.",
  "settings.mcp.errors.noConfig": "Не може да се прочита конфигурацијата за {{name}} — може да е дефинирана надвор од проектот.",
  "settings.mcp.edit.warn": "Зачувувањето повторно го поврзува овој сервер.",
  "settings.plugins.search.placeholder": "Барај додатоци…",
  "settings.plugins.detail.install": "Инсталирај…",
  "settings.plugins.detail.copy": "Копирај фрагмент од конфигурација",
  "settings.plugins.detail.copied": "Копирано",
  "settings.plugins.detail.notOnNpm": "Не е пронајдено на npm — додајте рачно во opencode.json",
  "settings.plugins.install.title": "Инсталирај додаток",
  "settings.plugins.install.description": "Каде да се додаде {{name}}?",
  "settings.plugins.install.global": "Глобално (~/.config/opencode)",
  "settings.plugins.install.project": "Овој проект",
  "settings.plugins.install.cancel": "Откажи",
  "settings.plugins.install.success": "{{name}} е инсталиран. Рестартирајте го OpenCode за да се вчита.",
  "settings.plugins.installed.empty": "Нема инсталирани додатоци.",
  "settings.plugins.installed.provenance.global": "Глобално",
  "settings.plugins.installed.provenance.project": "Проект",
  "settings.plugins.installed.disable": "Оневозможи",
  "settings.plugins.installed.enable": "Овозможи",
  "settings.plugins.installed.uninstall": "Деинсталирај",
  "settings.plugins.installed.uninstallBody": "Да се деинсталира {{name}} од {{scope}}? Ќе биде отстранет од конфигурациската датотека.",
  "settings.plugins.installed.recentlyRemoved": "Неодамна отстранети",
  "settings.plugins.installed.openConfig": "Отвори конфигурација",
  "settings.plugins.errors.parseFailed": "Не може да се прочита {{path}} — поправете или отстранете ја датотеката за управување со додатоци таму.",
  "settings.plugins.errors.catalog": "Не може да се освежи каталозите на додатоци.",
  "settings.plugins.stale": "Прикажан е кеширан каталог ({{age}} стар).",
