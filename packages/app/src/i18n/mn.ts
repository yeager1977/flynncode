...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "клиент бүртгэл шаардлагатай",
  "mcp.status.pending": "холбогдож байна…",
  ...
  "settings.tab.plugins": "Плагинууд",
  "settings.plugins.section.browse": "Хайх",
  "settings.plugins.section.installed": "Суулгасан",
  "settings.plugins.source.all": "Бүх эх сурвалж",
  "settings.plugins.source.ecosystem": "Экосистем",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Сервер нэмэх",
  "settings.mcp.type.local": "Локал",
  "settings.mcp.type.remote": "Алс",
  "settings.mcp.empty": "Тохиргоотой MCP сервер байхгүй.",
  "settings.mcp.deleted": "{{name}} устгагдлаа.",
  "settings.mcp.errors.refresh": "MCP серверүүдийг ачаалж чадсангүй.",
  "settings.mcp.status.pending": "холбогдож байна…",
  "settings.mcp.action.connect": "Холбох",
  "settings.mcp.action.disconnect": "Салгах",
  "settings.mcp.action.authenticate": "Нотлох",
  "settings.mcp.action.edit": "Засах",
  "settings.mcp.action.delete": "Устгах",
  "settings.mcp.delete.title": "MCP сервер устгах",
  "settings.mcp.delete.body": "{{name}}-ийг хасах уу? Буцаах боломжгүй.",
  "settings.mcp.form.title.add": "MCP сервер нэмэх",
  "settings.mcp.form.title.edit": "MCP сервер засах",
  "settings.mcp.form.subtitle": "Холболтын тохиргоог хийнэ үү.",
  "settings.mcp.form.name": "Нэр",
  "settings.mcp.form.command": "Команд",
  "settings.mcp.form.command.hint": "жнь. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Ажлын хавтас",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Орчны хувьсагчид",
  "settings.mcp.form.headers": "Толгой",
  "settings.mcp.form.addRow": "Мөр нэмэх",
  "settings.mcp.form.removeRow": "Устгах",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Клиентийн ID",
  "settings.mcp.form.oauth.clientSecret": "Клиентийн нууц",
  "settings.mcp.form.oauth.clientSecret.keep": "Алгасахын тулд хоосон орхи — дахин нэвтрэх шаардлагатай болмож",
  "settings.mcp.form.oauth.scope": "Хамрагдах хүрээ",
  "settings.mcp.form.oauth.callbackPort": "Буцааж дуудах порт",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth автомат танихыг идэвхгүй болгох",
  "settings.mcp.form.enabled": "Идэвхтэй",
  "settings.mcp.form.timeout": "Хугацаа (ms)",
  "settings.mcp.form.save": "Хадгалах",
  "settings.mcp.form.cancel": "Цуцлах",
  "settings.mcp.form.error.name": "Нэр оруулна уу.",
  "settings.mcp.form.error.command": "Команд оруулна уу.",
  "settings.mcp.form.error.url": "URL оруулна уу.",
  "settings.mcp.form.error.callbackPort": "Буцааж дуудах порт 1-65535 байх ёстой.",
  "settings.mcp.form.error.timeout": "Хугацаа эерэг бүхэл тоо байх ёстой.",
  "settings.mcp.errors.invalid": "Онцлогдсон талбаруудыг засна уу.",
  "settings.mcp.errors.duplicate": "Энэ нэртэй сервер аль хэдийн байна.",
  "settings.mcp.errors.noConfig": "{{name}}-ийн тохиргоог уншиж чадсангүй — төслийн гадна тодорхойлогдсон байж болно.",
  "settings.mcp.edit.warn": "Хадгалахад энэ сервер дахин холбогдоно.",
  "settings.plugins.search.placeholder": "Плагин хайх…",
  "settings.plugins.detail.install": "Суулгах…",
  "settings.plugins.detail.copy": "Тохиргооны хэсгийг хуулах",
  "settings.plugins.detail.copied": "Хуулагдсан",
  "settings.plugins.detail.notOnNpm": "npm-д олдсонгүй — opencode.json-д гараар нэмнэ үү",
  "settings.plugins.install.title": "Плагин суулгах",
  "settings.plugins.install.description": "{{name}}-ийг хаана нэмэх вэ?",
  "settings.plugins.install.global": "Глобал (~/.config/opencode)",
  "settings.plugins.install.project": "Энэ төсөл",
  "settings.plugins.install.cancel": "Цуцлах",
  "settings.plugins.install.success": "{{name}} суулгагдлаа. Ачаалахын тулд OpenCode-г дахин эхлүүлнэ үү.",
  "settings.plugins.installed.empty": "Суулгасан плагин алга.",
  "settings.plugins.installed.provenance.global": "Глобал",
  "settings.plugins.installed.provenance.project": "Төсөл",
  ...
  "settings.plugins.errors.catalog": "Плагины каталог шинэчлэгдсэнгүй.",
  "settings.plugins.stale": "Кэшлэгдсэн каталогийг харуулж байна ({{age}}-ийн өмнөх).",
