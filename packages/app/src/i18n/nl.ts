...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "clientregistratie nodig",
  ...
  "settings.plugins.section.browse": "Bladeren",
  ...
  "settings.mcp.add": "Server toevoegen",
  "settings.mcp.type.local": "Lokaal",
  "settings.mcp.type.remote": "Extern",
  "settings.mcp.empty": "Geen MCP-servers geconfigureerd.",
  "settings.mcp.deleted": "{{name}} verwijderd.",
  "settings.mcp.errors.refresh": "Kan MCP-servers niet laden.",
  "settings.mcp.status.pending": "verbinden…",
  "settings.mcp.action.connect": "Verbinden",
  "settings.mcp.action.disconnect": "Verbreken",
  "settings.mcp.action.authenticate": "Authenticeren",
  "settings.mcp.action.edit": "Bewerken",
  "settings.mcp.action.delete": "Verwijderen",
  "settings.mcp.delete.title": "MCP-server verwijderen",
  "settings.mcp.delete.body": "{{name}} verwijderen? Dit kan niet ongedaan worden gemaakt.",
  "settings.mcp.form.title.add": "MCP-server toevoegen",
  "settings.mcp.form.title.edit": "MCP-server bewerken",
  "settings.mcp.form.subtitle": "Configureer de verbindingsinstellingen.",
  "settings.mcp.form.name": "Naam",
  "settings.mcp.form.command": "Commando",
  "settings.mcp.form.command.hint": "bijv. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Werkmap",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Omgevingsvariabelen",
  "settings.mcp.form.headers": "Headers",
  "settings.mcp.form.addRow": "Rij toevoegen",
  "settings.mcp.form.removeRow": "Verwijderen",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Client-ID",
  "settings.mcp.form.oauth.clientSecret": "Clientgeheim",
  "settings.mcp.form.oauth.clientSecret.keep": "Laat leeg om weg te laten — herauthenticatie kan vereist zijn",
  "settings.mcp.form.oauth.scope": "Scope",
  "settings.mcp.form.oauth.callbackPort": "Callbackpoort",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth-autodetectie uitschakelen",
  "settings.mcp.form.enabled": "Ingeschakeld",
  "settings.mcp.form.timeout": "Time-out (ms)",
  "settings.mcp.form.save": "Opslaan",
  "settings.mcp.form.cancel": "Annuleren",
  "settings.mcp.form.error.name": "Voer een naam in.",
  "settings.mcp.form.error.command": "Voer een commando in.",
  "settings.mcp.form.error.url": "Voer een URL in.",
  "settings.mcp.form.error.callbackPort": "Callbackpoort moet tussen 1 en 65535 liggen.",
  "settings.mcp.form.error.timeout": "Time-out moet een positief geheel getal zijn.",
  "settings.mcp.errors.invalid": "Corrigeer de gemarkeerde velden.",
  "settings.mcp.errors.duplicate": "Er bestaat al een server met deze naam.",
  "settings.mcp.errors.noConfig": "Kan de configuratie van {{name}} niet lezen — mogelijk buiten het project gedefinieerd.",
  "settings.mcp.edit.warn": "Opslaan herstelt de verbinding met deze server.",
  ...
  "settings.plugins.detail.copied": "Gekopieerd",
  "settings.plugins.detail.notOnNpm": "Niet gevonden op npm — voeg handmatig toe aan opencode.json",
  "settings.plugins.install.title": "Plugin installeren",
  "settings.plugins.install.description": "Waar moet {{name}} worden toegevoegd?",
  "settings.plugins.install.global": "Globaal (~/.config/opencode)",
  "settings.plugins.install.project": "Dit project",
  "settings.plugins.install.cancel": "Annuleren",
  "settings.plugins.install.success": "{{name}} geïnstalleerd. Herstart OpenCode om het te laden.",
  "settings.plugins.installed.empty": "Geen plugins geïnstalleerd.",
  "settings.plugins.installed.provenance.global": "Globaal",
  ...
  "settings.plugins.errors.catalog": "Kan de plugin-catalogus niet verversen.",
  "settings.plugins.stale": "Gecachte catalogus wordt getoond ({{age}} oud).",
