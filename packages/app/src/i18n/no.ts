...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "klientregistrering kreves",
  "mcp.status.pending": "kobler til…",
  ...
  "settings.tab.plugins": "Pluginer",
  "settings.plugins.section.browse": "Bla gjennom",
  ...
  "settings.mcp.add": "Legg til server",
  "settings.mcp.type.local": "Lokal",
  "settings.mcp.type.remote": "Ekstern",
  "settings.mcp.empty": "Ingen MCP-servere konfigurert.",
  "settings.mcp.deleted": "{{name}} slettet.",
  "settings.mcp.errors.refresh": "Kunne ikke laste inn MCP-servere.",
  "settings.mcp.status.pending": "kobler til…",
  "settings.mcp.action.connect": "Koble til",
  "settings.mcp.action.disconnect": "Koble fra",
  "settings.mcp.action.authenticate": "Autentiser",
  "settings.mcp.action.edit": "Rediger",
  "settings.mcp.action.delete": "Slett",
  "settings.mcp.delete.title": "Slett MCP-server",
  "settings.mcp.delete.body": "Fjerne {{name}}? Dette kan ikke angres.",
  "settings.mcp.form.title.add": "Legg til MCP-server",
  "settings.mcp.form.title.edit": "Rediger MCP-server",
  "settings.mcp.form.subtitle": "Konfigurer tilkoblingsinnstillingene.",
  ...
  "settings.mcp.form.cwd": "Arbeidsmappe",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Miljøvariabler",
  "settings.mcp.form.headers": "Headere",
  "settings.mcp.form.addRow": "Legg til rad",
  "settings.mcp.form.removeRow": "Fjern",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Klient-ID",
  "settings.mcp.form.oauth.clientSecret": "Klienthemmelighet",
  "settings.mcp.form.oauth.clientSecret.keep": "La stå tom for å utelate — reautentisering kan være nødvendig",
  "settings.mcp.form.oauth.scope": "Omfang",
  "settings.mcp.form.oauth.callbackPort": "Callback-port",
  "settings.mcp.form.oauth.disableAutodetect": "Deaktiver automatisk OAuth-oppdaging",
  "settings.mcp.form.enabled": "Aktivert",
  "settings.mcp.form.timeout": "Tidsavbrudd (ms)",
  "settings.mcp.form.save": "Lagre",
  "settings.mcp.form.cancel": "Avbryt",
  "settings.mcp.form.error.name": "Skriv inn et navn.",
  "settings.mcp.form.error.command": "Skriv inn en kommando.",
  "settings.mcp.form.error.url": "Skriv inn en URL.",
  "settings.mcp.form.error.callbackPort": "Callback-porten må være mellom 1 og 65535.",
  "settings.mcp.form.error.timeout": "Tidsavbruddet må være et positivt heltall.",
  "settings.mcp.errors.invalid": "Rett de merkede feltene.",
  "settings.mcp.errors.duplicate": "En server med dette navnet finnes allerede.",
  "settings.mcp.errors.noConfig": "Kan ikke lese konfigurasjonen for {{name}} — kan være definert utenfor prosjektet.",
  "settings.mcp.edit.warn": "Lagring kobler serveren til på nytt.",
  ...
  "settings.plugins.detail.notOnNpm": "Ikke funnet på npm — legg til manuelt i opencode.json",
  "settings.plugins.install.title": "Installer plugin",
  "settings.plugins.install.description": "Hvor skal {{name}} legges til?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Dette prosjektet",
  "settings.plugins.install.cancel": "Avbryt",
  "settings.plugins.install.success": "{{name}} installert. Start OpenCode på nytt for å laste det.",
  "settings.plugins.installed.empty": "Ingen pluginer installert.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Prosjekt",
  ...
  "settings.plugins.errors.catalog": "Kunne ikke oppdatere plugin-katalogen.",
  "settings.plugins.stale": "Viser bufret katalog ({{age}} gammel).",
