...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "требуется регистрация клиента",
  "mcp.status.pending": "подключение…",
  ...
  "settings.plugins.section.browse": "Обзор",
  ...
  "settings.mcp.type.remote": "Удалённый",
  "settings.mcp.empty": "Серверы MCP не настроены.",
  "settings.mcp.deleted": "{{name}} удалён.",
  "settings.mcp.errors.refresh": "Не удалось загрузить серверы MCP.",
  "settings.mcp.status.pending": "подключение…",
  "settings.mcp.action.connect": "Подключить",
  "settings.mcp.action.disconnect": "Отключить",
  "settings.mcp.action.authenticate": "Аутентифицировать",
  "settings.mcp.action.edit": "Изменить",
  "settings.mcp.action.delete": "Удалить",
  "settings.mcp.delete.title": "Удалить сервер MCP",
  "settings.mcp.delete.body": "Удалить {{name}}? Это действие нельзя отменить.",
  "settings.mcp.form.title.add": "Добавить сервер MCP",
  "settings.mcp.form.title.edit": "Изменить сервер MCP",
  "settings.mcp.form.subtitle": "Настройте параметры подключения.",
  ...
  "settings.mcp.form.cwd": "Рабочий каталог",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Переменные окружения",
  "settings.mcp.form.headers": "Заголовки",
  "settings.mcp.form.addRow": "Добавить строку",
  "settings.mcp.form.removeRow": "Удалить",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID клиента",
  "settings.mcp.form.oauth.clientSecret": "Секрет клиента",
  "settings.mcp.form.oauth.clientSecret.keep": "Оставьте пустым, чтобы пропустить — может потребоваться повторная аутентификация",
  "settings.mcp.form.oauth.scope": "Область",
  "settings.mcp.form.oauth.callbackPort": "Порт обратного вызова",
  "settings.mcp.form.oauth.disableAutodetect": "Отключить автоопределение OAuth",
  "settings.mcp.form.enabled": "Включён",
  "settings.mcp.form.timeout": "Таймаут (мс)",
  "settings.mcp.form.save": "Сохранить",
  "settings.mcp.form.cancel": "Отмена",
  "settings.mcp.form.error.name": "Введите имя.",
  "settings.mcp.form.error.command": "Введите команду.",
  "settings.mcp.form.error.url": "Введите URL.",
  "settings.mcp.form.error.callbackPort": "Порт обратного вызова должен быть от 1 до 65535.",
  "settings.mcp.form.error.timeout": "Таймаут должен быть положительным целым числом.",
  "settings.mcp.errors.invalid": "Исправьте выделенные поля.",
  "settings.mcp.errors.duplicate": "Сервер с таким именем уже существует.",
  "settings.mcp.errors.noConfig": "Не удаётся прочитать конфигурацию {{name}} — возможно, она определена вне проекта.",
  "settings.mcp.edit.warn": "Сохранение переподключает сервер.",
  ...
  "settings.plugins.detail.copied": "Скопировано",
  "settings.plugins.detail.notOnNpm": "Не найден на npm — добавьте вручную в opencode.json",
  "settings.plugins.install.title": "Установить плагин",
  "settings.plugins.install.description": "Куда добавить {{name}}?",
  "settings.plugins.install.global": "Глобально (~/.config/opencode)",
  "settings.plugins.install.project": "Этот проект",
  "settings.plugins.install.cancel": "Отмена",
  "settings.plugins.install.success": "{{name}} установлен. Перезапустите OpenCode, чтобы загрузить его.",
  "settings.plugins.installed.empty": "Плагины не установлены.",
  ...
  "settings.plugins.errors.catalog": "Не удалось обновить каталог плагинов.",
  "settings.plugins.stale": "Показан кэшированный каталог ({{age}}).",
