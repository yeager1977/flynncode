...
export const dict: Record<string, string> = {
  ...
  "mcp.status.needs_client_registration": "සේවාලාභී ලියාපදිංචිය අවශ්‍යයි",
  "mcp.status.pending": "සම්බන්ධ වෙමින්…",
  ...
  "settings.tab.plugins": "ප්ලගින",
  "settings.plugins.section.browse": "පිරික්සන්න",
  "settings.plugins.section.installed": "ස්ථාපිතයි",
  ...
  "settings.mcp.add": "සේවාදායකය එකතු කරන්න",
  "settings.mcp.type.local": "ස්ථානීය",
  "settings.mcp.type.remote": "දුරස්ථ",
  "settings.mcp.empty": "වින්‍යාස කර ඇති MCP සේවාදායක නැත.",
  "settings.mcp.deleted": "{{name}} මකා දන්වා ඇත.",
  "settings.mcp.errors.refresh": "MCP සේවාදායක පූරණය කළ නොහැක.",
  "settings.mcp.status.pending": "සම්බන්ධ වෙමින්…",
  "settings.mcp.action.connect": "සම්බන්ධ කරන්න",
  "settings.mcp.action.disconnect": "විසන්ධි කරන්න",
  "settings.mcp.action.authenticate": "සත්‍යාපනය කරන්න",
  "settings.mcp.action.edit": "සංස්කරණය",
  "settings.mcp.action.delete": "මකන්න",
  "settings.mcp.delete.title": "MCP සේවාදායකය මකන්න",
  "settings.mcp.delete.body": "{{name}} ඉවත් කරන්නද? මෙය අවලංගු කළ නොහැක.",
  "settings.mcp.form.title.add": "MCP සේවාදායකය එකතු කරන්න",
  "settings.mcp.form.title.edit": "MCP සේවාදායකය සංස්කරණය",
  "settings.mcp.form.subtitle": "සම්බන්ධතා සැකසුම් වින්‍යාසගත කරන්න.",
  "settings.mcp.form.name": "නම",
  "settings.mcp.form.command": "විධානය",
  "settings.mcp.form.command.hint": "උදා. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "වැඩ නාමාවලිය",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "පරිසර විචල්‍ය",
  "settings.mcp.form.headers": "ශීර්ෂ",
  "settings.mcp.form.addRow": "පේළිය එකතු කරන්න",
  "settings.mcp.form.removeRow": "ඉවත් කරන්න",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "සේවාලාභී ID",
  "settings.mcp.form.oauth.clientSecret": "සේවාලාභී රහස",
  "settings.mcp.form.oauth.clientSecret.keep": "මගහැරීමට හිස්ව තබන්න — නැවත සත්‍යාපනය අවශ්‍ය විය හැක",
  "settings.mcp.form.oauth.scope": "විෂය පථය",
  "settings.mcp.form.oauth.callbackPort": "පසුබල වරාය",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth ස්වයංක්‍රීය අනාවරණය අක්‍රීය",
  "settings.mcp.form.enabled": "සක්‍රීය",
  "settings.mcp.form.timeout": "වේලා සීමාව (ms)",
  "settings.mcp.form.save": "සුරකින්න",
  "settings.mcp.form.cancel": "අවලංගු",
  "settings.mcp.form.error.name": "නමක් ඇතුළත් කරන්න.",
  "settings.mcp.form.error.command": "විධානයක් ඇතුළත් කරන්න.",
  "settings.mcp.form.error.url": "URL එකක් ඇතුළත් කරන්න.",
  "settings.mcp.form.error.callbackPort": "පසුබල වරාය 1-65535 අතර විය යුතුය.",
  "settings.mcp.form.error.timeout": "වේලා සීමාව ධන නිඛිල සංඛ්‍යාවක් විය යුතුය.",
  "settings.mcp.errors.invalid": "උද්දීපිත ක්ෂේත්‍ර සංශෝධනය.",
  "settings.mcp.errors.duplicate": "මෙම නමින් සේවාදායකයෙක් දැනටමත් ඇත.",
  "settings.mcp.errors.noConfig": "{{name}} හි වින්‍යාසය කියවිය නොහැක — ව්‍යාපෘතියෙන් පිටත අර්ථ දක්වා ඇති විය හැක.",
  "settings.mcp.edit.warn": "සුරැකීම මෙම සේවාදායකය නැවත සම්බන්ධ කරයි.",
  ...
  "settings.plugins.detail.copied": "පිටපත් විය",
  "settings.plugins.detail.notOnNpm": "npm හි හමු නොවීයි — opencode.json වෙත අතින් එකතු කරන්න",
  "settings.plugins.install.title": "ප්ලගිනය ස්ථාපනය කරන්න",
  "settings.plugins.install.description": "{{name}} කොහෙද එකතු විය යුත්තේ?",
  "settings.plugins.install.global": "ගෝලීය (~/.config/opencode)",
  "settings.plugins.install.project": "මෙම ව්‍යාපෘතිය",
  "settings.plugins.install.cancel": "අවලංගු කරන්න",
  "settings.plugins.install.success": "{{name}} ස්ථාපනය විය. පූරණයට OpenCode නැවත ආරම්භ කරන්න.",
  "settings.plugins.installed.empty": "ස්ථාපිත ප්ලගින නැත.",
  "settings.plugins.installed.provenance.global": "ගෝලීය",
  "settings.plugins.installed.provenance.project": "ව්‍යාපෘතිය",
  ...
  "settings.plugins.errors.catalog": "ප්ලගින නාමාවලිය නැවුම් කළ නොහැක.",
  "settings.plugins.stale": "නිහිතගත නාමාවලිය පෙන්වමින් ({{age}} පැරණි).",
