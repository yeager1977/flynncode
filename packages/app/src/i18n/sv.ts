...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "klientregistrering krävs",
  "mcp.status.pending": "ansluter…",
  ...
  "settings.plugins.section.browse": "Bläddra",
  "settings.plugins.section.installed": "Installerade",
  "settings.plugins.source.all": "Alla källor",
  "settings.plugins.source.ecosystem": "Ekosystem",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Lägg till server",
  "settings.mcp.type.local": "Lokal",
  "settings.mcp.type.remote": "Fjärr",
  "settings.mcp.empty": "Inga MCP-servrar konfigurerade.",
  "settings.mcp.deleted": "{{name}} borttagen.",
  "settings.mcp.errors.refresh": "Kunde inte läsa in MCP-servrar.",
  "settings.mcp.status.pending": "ansluter…",
  "settings.mcp.action.connect": "Anslut",
  "settings.mcp.action.disconnect": "Koppla från",
  "settings.mcp.action.authenticate": "Autentisera",
  "settings.mcp.action.edit": "Redigera",
  "settings.mcp.action.delete": "Ta bort",
  "settings.mcp.delete.title": "Ta bort MCP-server",
  "settings.mcp.delete.body": "Ta bort {{name}}? Detta kan inte ångras.",
  "settings.mcp.form.title.add": "Lägg till MCP-server",
  "settings.mcp.form.title.edit": "Redigera MCP-server",
  "settings.mcp.form.subtitle": "Konfigurera anslutningsinställningarna.",
  "settings.mcp.form.name": "Namn",
  "settings.mcp.form.command": "Kommando",
  "settings.mcp.form.command.hint": "t.ex. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Arbetskatalog",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Miljövariabler",
  "settings.mcp.form.headers": "Rubriker",
  "settings.mcp.form.addRow": "Lägg till rad",
  "settings.mcp.form.removeRow": "Ta bort",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Klient-ID",
  "settings.mcp.form.oauth.clientSecret": "Klienthemlighet",
  "settings.mcp.form.oauth.clientSecret.keep": "Lämna tomt för att utelämna — omautentisering kan krävas",
  "settings.mcp.form.oauth.scope": "Omfattning",
  "settings.mcp.form.oauth.callbackPort": "Callback-port",
  "settings.mcp.form.oauth.disableAutodetect": "Inaktivera OAuth-autoidentifiering",
  "settings.mcp.form.enabled": "Aktiverad",
  "settings.mcp.form.timeout": "Timeout (ms)",
  "settings.mcp.form.save": "Spara",
  "settings.mcp.form.cancel": "Avbryt",
  "settings.mcp.form.error.name": "Ange ett namn.",
  "settings.mcp.form.error.command": "Ange ett kommando.",
  "settings.mcp.form.error.url": "Ange en URL.",
  "settings.mcp.form.error.callbackPort": "Callback-porten måste vara mellan 1 och 65535.",
  "settings.mcp.form.error.timeout": "Timeout måste vara ett positivt heltal.",
  "settings.mcp.errors.invalid": "Åtgärda de markerade fälten.",
  "settings.mcp.errors.duplicate": "En server med det här namnet finns redan.",
  "settings.mcp.errors.noConfig": "Kan inte läsa konfigurationen för {{name}} — kan vara definierad utanför projektet.",
  "settings.mcp.edit.warn": "Spara återansluter servern.",
  "settings.plugins.search.placeholder": "Sök plugin…",
  "settings.plugins.detail.install": "Installera…",
  "settings.plugins.detail.copy": "Kopiera konfigurationsutdrag",
  "settings.plugins.detail.copied": "Kopierat",
  "settings.plugins.detail.notOnNpm": "Hittades inte på npm — lägg till manuellt i opencode.json",
  "settings.plugins.install.title": "Installera plugin",
  "settings.plugins.install.description": "Var ska {{name}} läggas till?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Detta projekt",
  "settings.plugins.install.cancel": "Avbryt",
  "settings.plugins.install.success": "{{name}} installerat. Starta om OpenCode för att läsa in det.",
  "settings.plugins.installed.empty": "Inga plugin installerade.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Projekt",
  "settings.plugins.installed.disable": "Inaktivera",
  "settings.plugins.installed.enable": "Aktivera",
  "settings.plugins.installed.uninstall": "Avinstallera",
  "settings.plugins.installed.uninstallBody": "Avinstallera {{name}} från {{scope}}? Den tas bort från konfigurationsfilen.",
  "settings.plugins.installed.recentlyRemoved": "Nyligen borttagna",
  "settings.plugins.installed.openConfig": "Öppna konfiguration",
  "settings.plugins.errors.parseFailed": "Kan inte läsa {{path}} — åtgärda eller ta bort filen för att hantera plugin där.",
  "settings.plugins.errors.catalog": "Kunde inte uppdatera plugin-katalogen.",
  "settings.plugins.stale": "Visar cachad katalog ({{age}} gammal).",
