...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "потрібна реєстрація клієнта",
  "mcp.status.pending": "з'єднання…",
  ...
  "settings.plugins.section.browse": "Огляд",
  "settings.plugins.section.installed": "Встановлені",
  ...
  "settings.mcp.add": "Додати сервер",
  "settings.mcp.type.local": "Локальний",
  "settings.mcp.type.remote": "Віддалений",
  "settings.mcp.empty": "Сервери MCP не налаштовано.",
  "settings.mcp.deleted": "{{name}} видалено.",
  "settings.mcp.errors.refresh": "Не вдалося завантажити сервери MCP.",
  "settings.mcp.status.pending": "з'єднання…",
  "settings.mcp.action.connect": "З'єднати",
  "settings.mcp.action.disconnect": "Роз'єднати",
  "settings.mcp.action.authenticate": "Автентифікувати",
  "settings.mcp.action.edit": "Змінити",
  "settings.mcp.action.delete": "Видалити",
  "settings.mcp.delete.title": "Видалити сервер MCP",
  "settings.mcp.delete.body": "Видалити {{name}}? Цю дію не можна скасувати.",
  "settings.mcp.form.title.add": "Додати сервер MCP",
  "settings.mcp.form.title.edit": "Змінити сервер MCP",
  "settings.mcp.form.subtitle": "Налаштуйте параметри з'єднання.",
  "settings.mcp.form.name": "Назва",
  "settings.mcp.form.command": "Команда",
  "settings.mcp.form.command.hint": "напр. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Робочий каталог",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Змінні середовища",
  "settings.mcp.form.headers": "Заголовки",
  "settings.mcp.form.addRow": "Додати рядок",
  "settings.mcp.form.removeRow": "Видалити",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID клієнта",
  "settings.mcp.form.oauth.clientSecret": "Секрет клієнта",
  "settings.mcp.form.oauth.clientSecret.keep": "Залиште порожнім, щоб пропустити — може знадобитися повторна автентифікація",
  "settings.mcp.form.oauth.scope": "Область",
  "settings.mcp.form.oauth.callbackPort": "Порт зворотного виклику",
  "settings.mcp.form.oauth.disableAutodetect": "Вимкнути автовизначення OAuth",
  "settings.mcp.form.enabled": "Увімкнено",
  "settings.mcp.form.timeout": "Час очікування (мс)",
  "settings.mcp.form.save": "Зберегти",
  "settings.mcp.form.cancel": "Скасувати",
  "settings.mcp.form.error.name": "Введіть назву.",
  "settings.mcp.form.error.command": "Введіть команду.",
  "settings.mcp.form.error.url": "Введіть URL.",
  "settings.mcp.form.error.callbackPort": "Порт зворотного виклику має бути від 1 до 65535.",
  "settings.mcp.form.error.timeout": "Час очікування має бути додатним цілим числом.",
  "settings.mcp.errors.invalid": "Виправте виділені поля.",
  "settings.mcp.errors.duplicate": "Сервер із такою назвою вже існує.",
  "settings.mcp.errors.noConfig": "Не вдається прочитати конфігурацію {{name}} — можливо, вона визначена поза проєктом.",
  "settings.mcp.edit.warn": "Збереження перепід'єднує сервер.",
  ...
  "settings.plugins.detail.copied": "Скопійовано",
  "settings.plugins.detail.notOnNpm": "Не знайдено на npm — додайте вручну до opencode.json",
  "settings.plugins.install.title": "Встановити плагін",
  "settings.plugins.install.description": "Куди додати {{name}}?",
  "settings.plugins.install.global": "Глобально (~/.config/opencode)",
  "settings.plugins.install.project": "Цей проєкт",
  "settings.plugins.install.cancel": "Скасувати",
  "settings.plugins.install.success": "{{name}} встановлено. Перезапустіть OpenCode, щоб завантажити його.",
  "settings.plugins.installed.empty": "Плагіни не встановлено.",
  "settings.plugins.installed.provenance.global": "Глобально",
  "settings.plugins.installed.provenance.project": "Проєкт",
  ...
  "settings.plugins.errors.catalog": "Не вдалося оновити каталог плагінів.",
  "settings.plugins.stale": "Показано кешований каталог ({{age}}).",
