...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "کلائنٹ رجسٹریشن درکار",
  "mcp.status.pending": "جڑ رہا ہے…",
  ...
  "settings.tab.plugins": "پلگ ان",
  "settings.plugins.section.browse": "براؤز کریں",
  ...
  "settings.mcp.add": "سرور شامل کریں",
  "settings.mcp.type.local": "لوکل",
  "settings.mcp.type.remote": "ریموٹ",
  "settings.mcp.empty": "کوئی MCP سرور کنفیگر نہیں ہے۔",
  "settings.mcp.deleted": "{{name}} حذف ہو گیا۔",
  "settings.mcp.errors.refresh": "MCP سرورز لوڈ نہیں ہو سکے۔",
  "settings.mcp.status.pending": "جڑ رہا ہے…",
  "settings.mcp.action.connect": "جڑیں",
  "settings.mcp.action.disconnect": "منقطع کریں",
  "settings.mcp.action.authenticate": "تصدیق کریں",
  "settings.mcp.action.edit": "ترمیم کریں",
  "settings.mcp.action.delete": "حذف کریں",
  "settings.mcp.delete.title": "MCP سرور حذف کریں",
  "settings.mcp.delete.body": "{{name}} ہٹائیں؟ یہ واپس نہیں ہو سکتا۔",
  "settings.mcp.form.title.add": "MCP سرور شامل کریں",
  "settings.mcp.form.title.edit": "MCP سرور ترمیم کریں",
  "settings.mcp.form.subtitle": "کنکشن کی ترتیبات مرتب کریں۔",
  "settings.mcp.form.name": "نام",
  "settings.mcp.form.command": "کمانڈ",
  "settings.mcp.form.command.hint": "مثلاً npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "ورکنگ ڈائریکٹری",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "ماحولیاتی متغیرات",
  "settings.mcp.form.headers": "ہیڈرز",
  "settings.mcp.form.addRow": "قطار شامل کریں",
  "settings.mcp.form.removeRow": "ہٹائیں",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "کلائنٹ آئی ڈی",
  "settings.mcp.form.oauth.clientSecret": "کلائنٹ سیکریٹ",
  "settings.mcp.form.oauth.clientSecret.keep": "چھوڑنے کے لیے خالی چھوڑیں — دوبارہ تصدیق درکار ہو سکتی ہے",
  "settings.mcp.form.oauth.scope": "سکوپ",
  "settings.mcp.form.oauth.callbackPort": "کال بیک پورٹ",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth خودکار شناخت بند کریں",
  "settings.mcp.form.enabled": "فعال",
  "settings.mcp.form.timeout": "ٹائم آؤٹ (ms)",
  "settings.mcp.form.save": "محفوظ کریں",
  "settings.mcp.form.cancel": "منسوخ کریں",
  "settings.mcp.form.error.name": "نام درج کریں۔",
  "settings.mcp.form.error.command": "کمانڈ درج کریں۔",
  "settings.mcp.form.error.url": "URL درج کریں۔",
  "settings.mcp.form.error.callbackPort": "کال بیک پورٹ 1 تا 65535 کے درمیان ہونا چاہیے۔",
  "settings.mcp.form.error.timeout": "ٹائم آؤٹ مثبت عدد ہونا چاہیے۔",
  "settings.mcp.errors.invalid": "نمایاں فیلڈز درست کریں۔",
  "settings.mcp.errors.duplicate": "اس نام کا سرور پہلے سے موجود ہے۔",
  "settings.mcp.errors.noConfig": "{{name}} کی ترتیب نہیں پڑھی جا سکی — پروجیکٹ کے باہر بیان ہو سکتی ہے۔",
  "settings.mcp.edit.warn": "محفوظ کرنے سے یہ سرور دوبارہ منسلک ہوگا۔",
  ...
  "settings.plugins.detail.copied": "کاپی ہو گیا",
  "settings.plugins.detail.notOnNpm": "npm پر نہیں ملا — opencode.json میں دستی طور پر شامل کریں",
  "settings.plugins.install.title": "پلگ ان انسٹال کریں",
  "settings.plugins.install.description": "{{name}} کہاں شامل کیا جائے؟",
  "settings.plugins.install.global": "عالمی (~/.config/opencode)",
  "settings.plugins.install.project": "یہ پروجیکٹ",
  "settings.plugins.install.cancel": "منسوخ کریں",
  "settings.plugins.install.success": "{{name}} انسٹال ہو گیا۔ لوڈ کرنے کے لیے OpenCode دوبارہ شروع کریں۔",
  "settings.plugins.installed.empty": "کوئی پلگ ان انسٹال نہیں۔",
  "settings.plugins.installed.provenance.global": "عالمی",
  "settings.plugins.installed.provenance.project": "پروجیکٹ",
  "settings.plugins.installed.disable": " غیر فعال کریں",
  "settings.plugins.installed.enable": "فعال کریں",
  "settings.plugins.installed.uninstall": "اَن انسٹال کریں",
  "settings.plugins.installed.uninstallBody": "کیا {{scope}} سے {{name}} اَن انسٹال کریں؟ یہ کنفیگ فائل سے ہٹا دیا جائے گا۔",
  "settings.plugins.installed.recentlyRemoved": "حال ہی میں ہٹائے گئے",
  "settings.plugins.installed.openConfig": "کنفیگ کھولیں",
  "settings.plugins.errors.parseFailed": "{{path}} پڑھا نہیں جا سکا — پلگ انز کے انتظام کے لیے فائل ٹھیک کریں یا ہٹائیں۔",
  "settings.plugins.errors.catalog": "پلگ ان کیٹلاگ تازہ نہیں کیا جا سکا۔",
  "settings.plugins.stale": "کیس شدہ کیٹلاگ دکھایا جا رہا ہے ({{age}} پرانا)۔",
