...
export const dict = {
  ...
  "settings.plugins.section.browse": "浏览",
  ...
  "settings.mcp.status.pending": "连接中…",
  "settings.mcp.action.connect": "连接",
  "settings.mcp.action.disconnect": "断开",
  "settings.mcp.action.authenticate": "认证",
  "settings.mcp.action.edit": "编辑",
  "settings.mcp.action.delete": "删除",
  "settings.mcp.delete.title": "删除 MCP 服务器",
  "settings.mcp.delete.body": "移除 {{name}}？此操作无法撤销。",
  "settings.mcp.form.title.add": "添加 MCP 服务器",
  "settings.mcp.form.title.edit": "编辑 MCP 服务器",
  "settings.mcp.form.subtitle": "配置连接设置。",
  ...
  "settings.mcp.form.cwd": "工作目录",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "环境变量",
  "settings.mcp.form.headers": "标头",
  "settings.mcp.form.addRow": "添加行",
  ...
  "settings.mcp.form.enabled": "已启用",
  "settings.mcp.form.timeout": "超时 (ms)",
  "settings.mcp.form.save": "保存",
  "settings.mcp.form.cancel": "取消",
  "settings.mcp.form.error.name": "请输入名称。",
  "settings.mcp.form.error.command": "请输入命令。",
  "settings.mcp.form.error.url": "请输入 URL。",
  "settings.mcp.form.error.callbackPort": "回调端口必须是 1 到 65535 之间的数字。",
  "settings.mcp.form.error.timeout": "超时必须是正整数。",
  "settings.mcp.errors.invalid": "请修正突出显示的字段。",
  "settings.mcp.errors.duplicate": "已存在同名服务器。",
  "settings.mcp.errors.noConfig": "无法读取 {{name}} 的配置 — 可能定义在项目之外。",
  "settings.mcp.edit.warn": "保存将重新连接此服务器。",
  "settings.plugins.search.placeholder": "搜索插件…",
  "settings.plugins.detail.install": "安装…",
  "settings.plugins.detail.copy": "复制配置片段",
  "settings.plugins.detail.copied": "已复制",
  "settings.plugins.detail.notOnNpm": "在 npm 上未找到 — 请手动添加到 opencode.json",
  "settings.plugins.install.title": "安装插件",
  "settings.plugins.install.description": "将 {{name}} 添加到哪里？",
  "settings.plugins.install.global": "全局 (~/.config/opencode)",
  "settings.plugins.install.project": "此项目",
  "settings.plugins.install.cancel": "取消",
  "settings.plugins.install.success": "已安装 {{name}}。重启 OpenCode 以加载。",
  "settings.plugins.installed.empty": "尚未安装任何插件。",
  "settings.plugins.installed.provenance.global": "全局",
  "settings.plugins.installed.provenance.project": "项目",
  ...
  "settings.plugins.errors.catalog": "无法刷新插件目录。",
  "settings.plugins.stale": "正在显示缓存目录（{{age}} 前）。",
