...
export const dict = {
  ...
  "settings.plugins.section.browse": "瀏覽",
  ...
  "settings.mcp.empty": "尚未設定 MCP 伺服器。",
  "settings.mcp.deleted": "已刪除 {{name}}。",
  "settings.mcp.errors.refresh": "無法載入 MCP 伺服器。",
  "settings.mcp.status.pending": "連線中…",
  "settings.mcp.action.connect": "連線",
  "settings.mcp.action.disconnect": "中斷連線",
  "settings.mcp.action.authenticate": "驗證",
  "settings.mcp.action.edit": "編輯",
  "settings.mcp.action.delete": "刪除",
  "settings.mcp.delete.title": "刪除 MCP 伺服器",
  "settings.mcp.delete.body": "移除 {{name}}？此操作無法復原。",
  "settings.mcp.form.title.add": "新增 MCP 伺服器",
  "settings.mcp.form.title.edit": "編輯 MCP 伺服器",
  "settings.mcp.form.subtitle": "設定連線設定。",
  "settings.mcp.form.name": "名稱",
  "settings.mcp.form.command": "命令",
  "settings.mcp.form.command.hint": "例如 npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "工作目錄",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "環境變數",
  "settings.mcp.form.headers": "標頭",
  "settings.mcp.form.addRow": "新增行",
  "settings.mcp.form.removeRow": "移除",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "用戶端 ID",
  "settings.mcp.form.oauth.clientSecret": "用戶端密碼",
  "settings.mcp.form.oauth.clientSecret.keep": "留空則省略 — 可能需要重新驗證",
  "settings.mcp.form.oauth.scope": "範圍",
  "settings.mcp.form.oauth.callbackPort": "回呼連接埠",
  "settings.mcp.form.oauth.disableAutodetect": "停用 OAuth 自動偵測",
  "settings.mcp.form.enabled": "已啟用",
  "settings.mcp.form.timeout": "逾時 (ms)",
  "settings.mcp.form.save": "儲存",
  "settings.mcp.form.cancel": "取消",
  "settings.mcp.form.error.name": "請輸入名稱。",
  "settings.mcp.form.error.command": "請輸入命令。",
  "settings.mcp.form.error.url": "請輸入 URL。",
  "settings.mcp.form.error.callbackPort": "回呼連接埠必須是 1 到 65535 之間的數字。",
  "settings.mcp.form.error.timeout": "逾時必須是正整數。",
  "settings.mcp.errors.invalid": "請修正醒目提示的欄位。",
  "settings.mcp.errors.duplicate": "已有同名伺服器。",
  "settings.mcp.errors.noConfig": "無法讀取 {{name}} 的設定 — 可能定義在專案之外。",
  "settings.mcp.edit.warn": "儲存會重新連線此伺服器。",
  "settings.plugins.search.placeholder": "搜尋外掛…",
  "settings.plugins.detail.install": "安裝…",
  "settings.plugins.detail.copy": "複製設定片段",
  "settings.plugins.detail.copied": "已複製",
  "settings.plugins.detail.notOnNpm": "在 npm 上找不到 — 請手動加入 opencode.json",
  "settings.plugins.install.title": "安裝外掛",
  "settings.plugins.install.description": "要將 {{name}} 加入哪裡？",
  "settings.plugins.install.global": "全域 (~/.config/opencode)",
  "settings.plugins.install.project": "此專案",
  "settings.plugins.install.cancel": "取消",
  "settings.plugins.install.success": "已安裝 {{name}}。重新啟動 OpenCode 以載入。",
  "settings.plugins.installed.empty": "尚未安裝任何外掛。",
  "settings.plugins.installed.provenance.global": "全域",
  "settings.plugins.installed.provenance.project": "專案",
  ...
  "settings.plugins.errors.catalog": "無法重新整理外掛目錄。",
  "settings.plugins.stale": "正在顯示快取目錄（{{age}} 前）。",
