...
type Endpoint4_0Request = Parameters<RawClient["server.import"]["import.session"]>[0]
type Endpoint4_0Input = {
  readonly source: Endpoint4_0Request["payload"]["source"]
  readonly sourceSessionID: Endpoint4_0Request["payload"]["sourceSessionID"]
  readonly sourcePath: Endpoint4_0Request["payload"]["sourcePath"]
  readonly title: Endpoint4_0Request["payload"]["title"]
  readonly location: Endpoint4_0Request["payload"]["location"]
  readonly transcript: Endpoint4_0Request["payload"]["transcript"]
}
const Endpoint4_0 = (raw: RawClient["server.import"]) => (input: Endpoint4_0Input) =>
  raw["import.session"]({
    payload: {
      source: input["source"],
...
type Endpoint4_1Request = Parameters<RawClient["server.import"]["import.imported"]>[0]
type Endpoint4_1Input = {
  readonly source: Endpoint4_1Request["query"]["source"]
  readonly directory: Endpoint4_1Request["query"]["directory"]
}
const Endpoint4_1 = (raw: RawClient["server.import"]) => (input: Endpoint4_1Input) =>
  raw["import.imported"]({ query: { source: input["source"], directory: input["directory"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )
...
const adaptClient = (raw: RawClient) => ({
  ...
  imports: adaptGroup4(raw["server.import"]),
